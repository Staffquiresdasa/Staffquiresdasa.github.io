!function (t, e, a) {
    "use strict";
    var n, i, s = t(e), r = t("body"), o = t("#slide-out-widget-area"), l = t("#slide-out-widget-area-bg"),
        d = t("#header-outer"), c = t("#header-secondary-outer"), h = t("#header-outer #search-btn a"),
        u = t("#wpadminbar"), p = t("#ajax-loading-screen"), f = t(".body-border-top"), g = t("#page-header-bg"),
        m = t("#footer-outer"),
        ...
        _ = d.is("[data-shrink-num]") ? d.attr("data-shrink-num") : 6, C = !!d.is('[data-condense="true"]'),
        x = !!d.is('[data-using-logo="1"]'), k = !!d.is('[data-header-resize="1"]'),
        $ = !!d.is('[data-transparent-header="true"]'),
        T = (d.is('[data-mobile-fixed="1"]'), r.is("[data-header-format]") ? r.attr("data-header-format") : "default"),
        I = r.is("[data-hhun]") ? r.attr("data-hhun") : "", E = !!r.is('[data-contained-header="true"]'),
        O = r.is("[data-cae]") && "swing" !== r.attr("data-cae") ? r.attr("data-cae") : "easeOutCubic",
        z = r.is("[data-cad]") ? r.attr("data-cad") : "650", H = t('body[data-animated-anchors="true"]').length > 0,
        ...
        M = [], W = [], B = [], F = [], L = [], q = [], j = [], P = [], Y = [], R = [], V = [], X = [], N = [], D = [],
        Q = [], Z = [], G = [], U = [], J = [], K = [], tt = [], et = [], at = [], nt = [], it = [], st = [], rt = [],
        ot = "", lt = !1, dt = !1, ct = {}, ht = {animating: "false", perspect: "not-rolled", inUse: !1},
    ...
    function Et() {
        t("nav:not(.left-side):not(.right-side) .sf-menu > .nectar-megamenu-menu-item.align-left:not(.width-100)").each(function () {
            var e = t(this), a = t("header#top > .container > .row"), n = t(this).find("> ul.sub-menu");
            if (e) {
            ...
            var e = t(this), a = t("header#top > .container > .row"), n = t(this).find("> ul.sub-menu");
            if (e && n.length > 0) {
                var i = a.width(), s = a.offset().left, r = e.offset().left, o = e.width(), l = n.width();
                n.css({right: i - (r + o - s) - l / 2 + o / 2, left: "auto"});
                var d = n.offset();
                d.left < 0 ? n.css({right: "auto", left: "0px"}) : d.left + l > pt.winW && n.css({
                    right: "0px",
                    left: "auto"
                })
            }
    ...
    function Ot() {
        var e = s.width(), a = t("header#top > .container").width();
    ...
    function Ht() {
        0 != t(".carousel").length && ("undefined" != typeof SalientRecentProjectsCarousel && t("ul.carousel.portfolio-items").each(function (e) {
            ...
            var a, n, i = t(this), s = "true" == t(this).parents(".carousel-wrap").attr("data-full-width") ? "auto" : 3,
                ...
                d = "true" == t(this).attr("data-autorotate"), c = !0, h = !0;
            ...
            0 == i.find("img").length && (u = r), imagesLoaded(u, function () {
                i.carouFredSel({
                    ...
                    swipe: {
                        ...
                        onMouse: !0,
                        options: {
                            excludedElements: "button, input, select, textarea, .noSwipe", tap: function (a, n) {
                    ...
                    scroll: {
                        items: o, easing: n, duration: a, onBefore: function () {
    ...
    function St() {
        0 !== t(".owl-carousel[data-desktop-cols]").length && t(".owl-carousel[data-desktop-cols]").each(function () {
            ...
            var e = t(this), a = e.attr("data-autorotate"), n = e.attr("data-autorotation-speed"),
                i = !!e.is('[data-loop="true"]'), s = !!r.hasClass("rtl");
            t(this).owlCarousel({
                responsive: {
                ...
                }, autoplay: a, autoplayTimeout: n, loop: i, rtl: s, smartSpeed: 350, onTranslate: function () {
                    e.addClass("moving")
    ...
    function Ft() {
        0 !== t(".carousel.clients").length && (t(".carousel.clients").each(function () {
            ...
            0 == a.find("img").length && (i = r), imagesLoaded(i, function () {
                ...
                }).animate({opacity: 1}, 1300), a.addClass("finished-loading"), a.parents(".carousel-wrap").wrap('<div class="carousel-outer">'), s.trigger("resize")
            })
    ...
    function Xt() {
        var e;
        if (r.is('[data-header-format="left-header"]') && pt.winW >= 1e3 || r.is('[data-hhun="1"]') || t(".page-template-template-no-header-footer").length > 0 || t(".page-template-template-no-header").length > 0) e = 0; else if (!0 === E) e = t("#header-outer").outerHeight() + parseInt(t("#header-outer").css("margin-top")); else {
            var a = y - y / 1.8, n = d.outerHeight();
    ...
    function Dt() {
        pt.usingMobileBrowser || (this.state = {ocmFocus: !1}, this.init(), this.events())
    }
    ...
    function Gt(t, n, i) {
        var s = e.scrollY || a.documentElement.scrollTop, r = (t = t || 0, n = n || 2e3, i = i || "easeOutSine", 0),
            o = Math.max(.1, Math.min(Math.abs(s - t) / n, .8)), l = {
                easeInOutQuint: function (t) {
                    return (t /= .5) < 1 ? .5 * Math.pow(t, 5) : .5 * (Math.pow(t - 2, 5) + 2)
                }
            };
        !function a() {
            var n = (r += 1 / 60) / o, d = l[i](n);
    ...
    e.nectarState = gt, yt.prototype.setup = function () {
        ...
        if ("IntersectionObserver" in e) {
            ...
            }, {rootMargin: "0px", threshold: 0}), this.observer.observe(this.$el[0])
        }
        ...
        if ("horizontal-movement" === this.iconType) e.$el.is('[data-indicator-blur="true"]') && e.$dragEl.addClass("blurred-bg"), e.$el.find(".flickity-viewport").on("mouseenter", function () {
            ...
            if (e.$dragEl.removeClass("color-dark").removeClass("color-light").removeClass("color-default"), "default" == e.styleType) e.$dragEl.addClass(t), e.$dragEl.find("> span, i").css("color", ""), e.$dragEl.find(".color-circle").css("background-color", ""); else if ("solid" == e.styleType) {
            ...
            var t = e.$el.attr("data-indicator-bg"), a = e.$el.attr("data-indicator-icon");
            ...
            var a = e.$el.is("[data-indicator-text-color]") ? e.$el.attr("data-indicator-text-color") : "#fff",
                n = e.$el.attr("data-indicator-color"), i = e.$el.attr("data-indicator-style"),
        ...
        this.updatePos(), this.$closeEl.css({transform: "translateX(" + this.lastX + "px) translateY(" + this.lastY + "px)"}), this.parallaxIcon(), requestAnimationFrame(this.closeRAF.bind(this))
        ...
        }, {root: jt() ? null : a, rootMargin: "350px 0px 350px 0px", threshold: 0}), this.observer.observe(this.$el[0])
        ...
        }, {root: jt() ? null : a, rootMargin: "200px 0px 200px 0px", threshold: 0}).observe(this.$el[0])
        ...
        this.instance.on("dragStart", function () {
            ...
            if (!0 !== n.$groupCellsBool) {
                var e = s.selectedSlide.outerWidth, a = s.size.innerWidth, i = Math.floor(a / e);
        ...
        if ("true" == this.$el.attr("data-arrows") && 0 == this.$el.find(".flickity-prev-next-button").length && (this.$el.append('<button class="flickity-button flickity-prev-next-button previous" aria-label="' + nectar_front_i18n.previous + '" type="button"><svg class="flickity-button-icon" viewBox="0 0 100 100"><path d="M 10,50 L 60,100 L 70,90 L 30,50  L 70,10 L 60,0 Z" class="arrow"></path></svg></button>'), this.$el.append('<button class="flickity-button flickity-prev-next-button next" aria-label="' + nectar_front_i18n.next + '" type="button"><svg class="flickity-button-icon" viewBox="0 0 100 100"><path d="M 10,50 L 60,100 L 70,90 L 30,50  L 70,10 L 60,0 Z" class="arrow" transform="translate(100, 100) rotate(180) "></path></svg></button>'), this.$el.find(".flickity-prev-next-button.previous").on("click", function () {
            ...
            handler: function () {
                e.find(".bg-layer[data-nectar-img-src]").each(function () {
                    var e = t(this)[0], a = e.getAttribute("data-nectar-img-src");
        ...
        if (this.$el.is('[data-parallax="true"]')) {
            ...
            this.instance.on("scroll", function () {
                t.each(a.instance.slides, function (t, e) {
                    var n = i[t].querySelector(".bg-layer"), r = i[t].querySelector(".inner"), o = a.instance, l = 0;
        ...
        var n = this.$el.find(".flickity-page-dots li").length, i = this.$el.find(".visualized-total span"), r = 1,
            o = this.$el.find(".visualized-total").width();
        a || (s.on("smartresize", function () {
            setTimeout(function () {
                n = e.find(".flickity-page-dots li").length, o = e.find(".visualized-total").width(), r = o / n * e.find(".flickity-page-dots .is-selected").index(), i.css("width", 100 / n + "%"), i.css({x: r + "px"})
            }, 200)
        }), setTimeout(function () {
            ...
            r = o / n * e.find(".flickity-page-dots .is-selected").index(), i.css({x: r + "px"})
        }))
    }, kt.prototype.fixedContentStyle = function () {
        var a = pt.usingMobileBrowser, n = this.$el, i = this;
        this.$flickity_stored_autoplay && (t(e).on("nectar-material-ocm-open", function () {
            ...
            if (!a) if (1 != gt.materialOffCanvasOpen) {
                ...
                o += parseInt(n.css("margin-left")) + 2, i.instance.slides.forEach(function (a, n) {
                    var s = 1, r = 0, l = 0, d = 10, c = 1, h = t(a.cells[0].element).offset().left,
                        u = t(".nectar-flickity.instance-" + i.index + " .cell:nth-child(" + (n + 1) + ")");
                    h - o < 0 && h - o > -1 * e ? (s = 1 + (h - o) / 1500, c = 1 + (h - o + 70) / 550, r = -1 * (h - o), l = (h - o) / 25 * -1) : (s = 1, c = 1, r = 0, l = 0), d = h + 5 - o < 0 && h - o > -1 * e ? 5 : 10, u.css({"z-index": d}), u.find(".inner-wrap-outer").css({
                ...
                a.find(".inner-wrap-outer").css({
                    ...
                    opacity: "1"
                }), a.find(".inner-wrap").css({transform: "scale(1) translateZ(0)"})
            })
        })
        ...
        }, {root: jt() ? null : a, rootMargin: "400px 0px 400px 0px", threshold: 0}), this.observer.observe(this.$el[0])
    }, Mt.prototype.legacyCarousel = function () {
        var a = this.$el.find("ul.products"), n = this.$el.parents(".full-width-content ").length > 0 ? 400 : 353,
            i = a;
        0 == a.find("img").length && (i = r), this.$el.append('<a class="carousel-prev" href="#"><i class="icon-salient-left-arrow"></i></a> <a class="carousel-next" href="#"><i class="icon-salient-right-arrow"></i></a>'), imagesLoaded(i, function () {
            a.carouFredSel({
                ...
                auto: {play: !1}
            }).animate({opacity: 1}, 1300), a.parents(".carousel-wrap").wrap('<div class="carousel-outer">'), a.addClass("finished-loading"), s.trigger("resize")
        })
        ...
        var n = !!a.is('[data-controls="bottom-pagination"]'), i = !a.is('[data-controls="bottom-pagination"]'),
            s = !a.is('[data-wrap="no-wrap"]'), o = 1 != s || n,
        ...
        if (e.nectarOptions && e.nectarOptions.woo_related_upsell_carousel && "true" == e.nectarOptions.woo_related_upsell_carousel && this.$el.hasClass("related-upsell-carousel") && (h = !0, s = !1, o = !0, "center" == c && this.$el.find(".products > div").length < 4 && (c = "left"), this.$el.find(".products > div").length < 5 && this.$el.addClass("desktop-controls-hidden")), this.instance.flickity({
            ...
            At({data: {wooFlickity: p, wooFlickityCount: u}}), this.instance.on("select.flickity", {
                wooFlickity: p,
                wooFlickityCount: u
            }, At)
        }
        ...
        var t, e, n, i, s, r;
        e = {hidden: !1}, n = (t = a).createElement("STYLE"), i = "addEventListener" in t, s = function (e, a) {
        ...
        n.VERSION = "3.2.0", n.DEFAULTS = {offset: 10}, n.prototype.calcPageSubemnu = function () {
            ...
            this.$body.find(this.selector).map(function () {
                var e = t(this), i = e.data("target") || e.attr("href");
                "#%20" === i && (i = "");
                var s = /^#./.test(i) && t(i);
            ...
            var e, a = pt.scrollTop + this.options.offset + this.pageSubmenuHeight, n = this.getScrollHeight(),
                i = this.options.offset + n - this.$scrollElement.height() - this.pageSubmenuHeight, s = this.offsets,
                r = this.targets, o = this.activeTarget;
        ...
        t.fn.scrollspy = function (e) {
            return this.each(function () {
                var a = t(this), i = a.data("bs.scrollspy"), s = "object" == typeof e && e;
    ...
    Kt = jQuery, te = Kt(e), Kt.fn.visible = function (t, e, a) {
        if (!(this.length < 1)) {
            var n = this.length > 1 ? this.eq(0) : this, i = n.get(0), s = te.width(), r = te.height(),
                o = (a = a || "both", !0 !== e || i.offsetWidth * i.offsetHeight);
            if ("function" == typeof i.getBoundingClientRect) {
                var l = i.getBoundingClientRect(), d = l.top >= 0 && l.top < r, c = l.bottom > 0 && l.bottom <= r,
                    h = l.left >= 0 && l.left < s, u = l.right > 0 && l.right <= s, p = t ? d || c : d && c,
                    f = t ? h || u : h && u;
                if ("both" === a) return o && p && f;
                if ("vertical" === a) return o && p;
                if ("horizontal" === a) return o && f
            } else {
                var g = te.scrollTop(), m = g + r, v = te.scrollLeft(), b = v + s, w = n.offset(), y = w.top,
                    _ = y + n.height(), C = w.left, x = C + n.width(), k = !0 === t ? _ : y, $ = !0 === t ? y : _,
                    T = !0 === t ? x : C, I = !0 === t ? C : x;
    ...
    var ae = function (t, n, i, s, r, o) {
        ...
        e.requestAnimationFrame || (e.requestAnimationFrame = function (t) {
            var a = (new Date).getTime(), n = Math.max(0, 16 - (a - l)), i = e.setTimeout(function () {
                t(a + n)
            }, n);
            return l = a + n, i
        ...
        "" === h.options.separator && (h.options.useGrouping = !1), h.options.prefix || (h.options.prefix = ""), h.options.suffix || (h.options.suffix = ""), h.d = "string" == typeof t ? a.getElementById(t) : t, h.startVal = Number(n), h.endVal = Number(i), h.countDown = h.startVal > h.endVal, h.frameVal = h.startVal, h.decimals = Math.max(0, s || 0), h.dec = Math.pow(10, h.decimals), h.duration = 1e3 * Number(r) || 2e3, h.formatNumber = function (t) {
            var e, a, n, i;
            if (t = t.toFixed(h.decimals), a = (e = (t += "").split("."))[0], n = e.length > 1 ? h.options.decimal + e[1] : "", i = /(\d+)(\d{3})/, h.options.useGrouping) for (; i.test(a);) a = a.replace(i, "$1" + h.options.separator + "$2");
    ...
    function ie(e, n) {
        if (e.length > 0) {
            var i = a.head || a.getElementsByTagName("head")[0], s = a.createElement("style");
        ...
        setTimeout(function () {
            t('body[data-ls="magnific"]').length > 0 || t('body[data-ls="pretty_photo"]').length > 0 ? (t("a.pp").removeClass("pp").addClass("magnific-popup"), t("a[rel^='prettyPhoto']:not([rel*='_gal']):not([rel*='product-gallery']):not([rel*='prettyPhoto['])").removeAttr("rel").addClass("magnific-popup"), t(".wpb_gallery .wpb_gallery_slidesnectarslider_style").each(function () {
                ...
                e.length > 0 && !e.hasClass("lightbox-col") && (e.magnificPopup({
                    type: "image", delegate: "a.magnific", mainClass: "mfp-zoom-in", fixedContentPos: !1, callbacks: {
                    ...
                    }, removalDelay: 400, gallery: {enabled: !0}
    ...
    function re() {
        t(ot + " .wpb_animate_when_almost_visible").each(function () {
            var e = t(this), a = 1 == lt ? "200%" : "90%", n = new Waypoint({
                element: e[0], handler: function () {
    ...
    function le() {
        t(ot + ".nectar-milestone").each(function () {
            ...
            var n = t(this), i = new Waypoint({
                element: n[0], handler: function () {
                    if (n.parents(".wpb_tab").length > 0 && "hidden" == n.parents(".wpb_tab").css("visibility") || n.hasClass("animated-in")) i.destroy(); else {
                        var e = n.find(".number span:not(.symbol)").text().replace(/,/g, ""), s = 0;
                        ...
                        e = parseFloat(e), setTimeout(function () {
                            if (n.hasClass("motion_blur")) n.find("span").each(function (e) {
                                ...
                                var a = {easingFn: ne}, i = n.find(".number span:not(.symbol)")[0];
    ...
    function ce() {
        r.on("click", ".tabbed > ul li:not(.cta-button) a", function (a) {
            if (function (a) {
                var n = a.parents("li").index() + 1, i = t("body.vc_editor").length > 0 ? "> .wpb_tab " : "";
                if (a.closest(".tabbed").length > 0 && a.closest(".tabbed").is('[data-style="toggle_button"]') && 3 === n && (n = 2), !a.hasClass("active-tab") && !a.hasClass("loading")) {
                    ...
                    if (t("body.vc_editor").length > 0) {
                        ...
                        a.parents('.tabbed[data-style="toggle_button"]').length > 0 && a.parents("li").index() + 1 === 3 && a.parents(".wpb_tabs_nav").find(".toggle-button[data-m-id]").length > 0 && (l = a.parents(".wpb_tabs_nav").find(".toggle-button").attr("data-m-id")), a.parents(".tabbed").find('> div[data-model-id="' + l + '"]' + i).css({
                            ...
                            left: "0",
                            display: "block"
                        }).stop().transition({opacity: 1}, o).addClass("visible-tab"), r.is('[data-flex-cols="true"]') || ui()
                    } else a.closest(".tabbed").find("> div:nth-of-type(" + n + ")" + i).css({
                        visibility: "visible",
                        position: "relative",
                        left: "0",
                        display: "block"
                    }).stop().transition({opacity: 1}, o).addClass("visible-tab");
            ...
            t(this).find("li").each(function () {
                var e = t(this).find("a").clone(), a = ee.tab, n = t(this);
        ...
        r.on("click", ".scrolling-tab-nav-current-item", function () {
            ...
            var i = t(this), s = i.parents("li").index() + 1, r = t("body.vc_editor").length > 0 ? "> .wpb_tab " : "",
                o = i.parents(".nectar-sticky-tabs"), l = o.hasClass("content_animation_fade") ? 200 : 600;
    ...
    function ue() {
        void 0 !== ee.toggle && t(".toggles").each(function () {
            t(this).find(".toggle").each(function () {
                var e = t(this).find("h3 a").clone(), a = ee.toggle;
    ...
    function fe() {
        setTimeout(function () {
            t('.toggles.accordion:not([data-starting="closed"])').each(function () {
                if (0 == t(this).find('.toggle[data-inner-wrap="true"]').length) t(this).find("> .toggle").first().addClass("open").find("> div").show(); else if (!pt.usingFrontEndEditor) {
        ...
        t(".nectar-3d-transparent-button").each(function () {
            if ("visible" == t(this).css("visibility")) {
                ...
                if ("extra_jumbo" == e.attr("data-size")) {
                    ...
                    var s = t(this).find(".back-3d .button-text")[0].getBoundingClientRect().width, r = 1.5 * i;
                    e.css({
                        width: s + 1.5 * a + "px",
                        height: r + a + "px"
                    }), e.find("> a").css({height: r + a + "px"}), e.find(".back-3d svg, .front-3d svg").css({
                        width: s + 1.5 * a + "px",
                        height: r + a + "px"
    ...
    function be() {
        if (pt.usingMobileBrowser || t('.nectar-cta[data-style="text-reveal-wave"], .menu-item-hover-text-reveal-wave, .nectar-cta[data-style="curved-arrow-animation"]').each(function () {
            ...
            var e = t(this).is('[data-using-bg="true"]') ? ".link_wrap" : ".link_text", a = !1;
            ...
            var i = parseInt(e.substring(1), 16),
                ...
                o = (16711680 & i) >> 16, l = (65280 & i) >> 8, d = (255 & i) >> 0,
            ...
            t(".swiper-slide .solid_color_2 a").each(function (n) {
                ...
                var i = t(this).css("background-color"), s = me(i, .13), r = me(i, -.15);
        ...
        if (t(".nectar-3d-transparent-button").length > 0) {
            ...
            t(".nectar-3d-transparent-button").each(function (e) {
                ...
                var d = t(this).find(".back-3d .button-text")[0].getBoundingClientRect().width, c = 1.5 * a;
                i.css({
                    width: d + 1.5 * r + "px",
                    height: c + r + "px"
                }), i.find("> a").css({height: c + r + "px"}), i.find(".back-3d svg, .front-3d svg").css({
                    width: d + 1.5 * r + "px",
                    height: c + r + "px"
    ...
    function Ce() {
        if (t(".morphing-outline").length > 0) {
            var e = "", a = t("body.vc_editor").length > 0 ? "" : ">";
            t(".morphing-outline").each(function (n) {
                t(this).removeClass(function (t, e) {
                    return (e.match(/(^|\s)instance-\S+/g) || []).join(" ")
                }), t(this).addClass("instance-" + n).css({visibility: "visible"});
                var i = t(this).find(".inner").width(), s = t(this).find(".inner").height(),
    ...
    function xe() {
        t(ot + ".nectar-fancy-ul").each(function () {
            var e = t(this).attr("data-animation"), a = 0;
                    ...
                    element: n[0], handler: function () {
                        n.parents(".wpb_tab").length > 0 && "hidden" == n.parents(".wpb_tab").css("visibility") || n.hasClass("animated-in") ? i.destroy() : (setTimeout(function () {
                            n.find("li").each(function (e) {
                                t(this).delay(220 * e).transition({opacity: "1", left: "0"}, 220, "easeOutCubic")
                            })
    ...
    function ke() {
        t('.nectar-fancy-ul:not([data-list-icon="dot"]):not([data-list-icon="none"])').each(function () {
            var e = t(this).attr("data-list-icon"), a = t(this).attr("data-color");
            t(this).find("li").each(function () {
    ...
    function $e() {
        t(".nectar-flip-box").each(function () {
            var e = parseInt(t(this).attr("data-min-height")), a = t(this).find(".flip-box-front .inner").height();
    ...
    function Ie() {
        if (0 != t('.carousel-wrap[data-full-width="true"], .portfolio-items[data-col-num="elastic"]:not(.fullwidth-constrained), #boxed .full-width-content').length) {
            ...
            if (1 == t("#boxed").length) i = (parseInt(t(".container-wrap").width()) - parseInt(t(".main-content").width())) / 2 + 4; else {
            ...
            t(".carousel-outer").has('.carousel-wrap[data-full-width="true"]').css("overflow", "visible"), t('.carousel-wrap[data-full-width="true"], .portfolio-items[data-col-num="elastic"]:not(.fullwidth-constrained), #boxed .full-width-content').each(function () {
                ...
                if (1 == t("#boxed").length) {
                    ...
                    if (t('body.single-post[data-ext-responsive="true"]').length > 0 && t(".container-wrap.no-sidebar").length > 0 && t(this).parents(".post-area").length > 0) f = t(".post-area").width(), p = 0, n = d - a; else {
                ...
                if (0 == t("#boxed").length && t(this).hasClass("portfolio-items") && t(this).is('[data-gutter*="px"]') && t(this).attr("data-gutter").length > 0 && "none" != t(this).attr("data-gutter") && (g = d > 1e3 ? d - a + 3 : d - a), t(this).parent().hasClass("default-style")) r = 0 == t("#nectar_fullscreen_rows").length ? parseInt(t(".main-content").width()) : parseInt(t(this).parents(".container").width()), 0 != t("#boxed").length ? g = 1 == t("#boxed").length ? r + parseInt(2 * i) : d + u : (g = 1 == t("#boxed").length ? r + parseInt(2 * i) : d - a - .025 * (d - a) + u, n = d - a <= r ? r : d - a - .025 * (d - a), i = Math.ceil((n - r) / 2)); else if (t(this).parent().hasClass("spaced")) if (r = 0 == t("#nectar_fullscreen_rows").length ? parseInt(t(".main-content").width()) : parseInt(t(this).parents(".container").width()), 0 != t("#boxed").length) g = 1 == t("#boxed").length ? r + parseInt(2 * i) - .02 * d : d + u; else {
                    g = 1 == t("#boxed").length ? r + parseInt(2 * i) : d - a - Math.ceil(.02 * (d - a)) + u;
                    var m = d - a <= r ? r : d - a - .02 * (d - a);
                    i = Math.ceil((m - r) / 2 + 2)
                }
                !t(this).parents(".span_9").length > 0 && !t(this).parent().hasClass("span_3") && "sidebar-inner" != t(this).parent().attr("id") && !t(this).find(".nectar-carousel-flickity-fixed-content").length > 0 && "portfolio-extra" != t(this).parent().attr("id") ? t(".single-product").length > 0 && t(this).parents("#tab-description").length > 0 && 0 == t(this).parents(".full-width-tabs").length ? t(this).css({visibility: "visible"}) : t(this).hasClass("portfolio-items") ? 0 == t(this).parents(".full-width-content").length && t(this).css({
                    "margin-left": -i,
                    left: 0,
                    width: g,
                    visibility: "visible"
                    ...
                    width: g,
                    visibility: "visible"
                }) : t(this).css({"margin-left": 0, width: "auto", left: "0", visibility: "visible"})
            })
        }
    }
    ...
    function Se(t) {
        this.$el = t, this.animations = {}, this.offsets = {}, this.topLevel = !1, this.timelines = {}, this.devices = {
            desktop: {
                min: 1e3,
                max: 1e7
            }, tablet: {min: 691, max: 999}, phone: {min: 0, max: 690}
    ...
    function Be() {
        pt.usingMobileBrowser && t('body[data-remove-m-parallax="1"]').length > 0 || t('.nectar-recent-posts-single_featured, [data-n-parallax-bg="true"], .wpb_row.parallax_section, #page-header-bg[data-parallax="1"] .page-header-bg-image-wrap, .parallax_slider_outer .nectar-slider-wrap .slide-bg-wrap').each(function () {
            ...
            if (0 == t(this).find(".row-bg").length && t(this).find(".page-header-bg-image").length > 0) ; else if (0 == t(this).find(".row-bg").length && t(this).find(".image-bg").length > 0) e = !1, 0 == t(".wpb_row").length && t(this).parents('.nectar-slider-wrap[data-full-width="true"]').length > 0 && t(this).parents(".parallax_slider_outer").length > 0 && "1" == t(this).parents(".parallax_slider_outer").index() && (e = !0), t("#portfolio-extra").length > 0 && t(this).parents(".wpb_row").length > 0 && t(this).parents(".parallax_slider_outer").length > 0 && "0" == t(this).parents(".wpb_row").index() && (e = !0), t(this).parents(".top-level").length > 0 && !pt.usingFrontEndEditor || e && !pt.usingFrontEndEditor ? t(this).find(".image-bg").css({height: Math.ceil(.25 * t(this).parent().offset().top) + t(this).outerHeight(!0)}) : t(this).find(".image-bg").css({height: Math.ceil(.25 * s.height()) + t(this).outerHeight(!0)}); else if (0 == t(this).find(".row-bg").length && t(this).find(".video-wrap").length > 0) {
                e = !1, 0 == t(".wpb_row").length && t(this).parents('.nectar-slider-wrap[data-full-width="true"]').length > 0 && t(this).parents(".parallax_slider_outer").length > 0 && "1" == t(this).parents(".parallax_slider_outer").index() && (e = !0), t("#portfolio-extra").length > 0 && t(this).parents(".wpb_row").length > 0 && t(this).parents(".parallax_slider_outer").length > 0 && "0" == t(this).parents(".wpb_row").index() && (e = !0), t(this).parents(".top-level").length > 0 && !pt.usingFrontEndEditor || e && !pt.usingFrontEndEditor ? t(this).find(".video-wrap").css({height: Math.ceil(.25 * t(this).parent().offset().top) + t(this).outerHeight(!0)}) : t(this).find(".video-wrap").css({height: Math.ceil(.25 * pt.winH) + t(this).outerHeight(!0)});
                var a = t(this).find(".video-wrap video"), n = a.parent().width() / 1280, i = a.parent().height() / 720,
                    r = n > i ? n : i;
                a.width(1280 * r), a.height(720 * r)
            } else if (t(this).is(".nectar-recent-posts-single_featured") && t(this).parents(".top-level").length > 0 && !pt.usingFrontEndEditor) ; else if (t(this).is(".nectar-simple-slider") && t(this).parents(".top-level").length > 0 && !pt.usingFrontEndEditor) ; else if (t(this).is(".column-image-bg-wrap") && t(this).parents(".top-level").length > 0 && t(this).parent().parent().is(".vc_col-sm-12:not(.child_column)")) ; else if (!t(this).hasClass("top-level") || pt.usingFrontEndEditor || t(this).find(".parallax-layer").length > 0) {
                var o = ".row-bg", l = t(this).find(".row-bg").attr("data-parallax-speed");
                ...
                t(this).find(o).css({height: Math.ceil(pt.winH * Me(l)) + t(this).outerHeight(!0) + d})
            }
        })
    }
    ...
    function Fe() {
        ...
        e = 0 == t("#portfolio-extra").length ? t(".main-content > .row > .wpb_row").length > 0 ? t(".main-content > .row > .wpb_row").length : t(".main-content > .row > *").length : t(".main-content > .row #portfolio-extra > *").length, t('.container-wrap .full-width-section, .container-wrap .full-width-content:not(.page-submenu .full-width-content):not(.blog-fullwidth-wrap), .row > .nectar-slider-wrap[data-full-width="true"], .wpb_wrapper > .nectar-slider-wrap[data-full-width="true"], .portfolio-items[data-col-num="elastic"]').each(function () {
            ...
            if (!t(this).parent().hasClass("span_9") && !t(this).parent().hasClass("span_3") && "sidebar-inner" != t(this).parent().attr("id")) if (t(this).parents(".wpb_row").length > 0) {
                t(this).parent();
            ...
            "0" == t(this).index() && 0 != g.length || "0" == t(this).index() ? t(this).addClass("first-section nder-page-header") : ("0" == t(this).index() && 0 == g.length || "0" == t(this).index()) && t(this).css({"margin-top": "0px"}).addClass("first-section")
    ...
    function Le() {
        var e = t("body.vc_editor").length > 0 ? ".vc_element > " : "", a = r.is('[data-flex-cols="true"]');
    ...
    function qe() {
        t(".wpb_row:has(.nectar-parallax-scene)").each(function (e) {
            ...
            U[e] = t(this).find(".nectar-parallax-scene").parallax({scalarX: a, scalarY: a});
    ...
    function Ye() {
        var a = 1 == lt ? "500%" : "88%", n = 1 == lt ? "500%" : "70%", i = 1 == lt ? "500%" : "70%";
        t(ot + ".img-with-animation").each(function (e) {
            var n = t(this), i = n.is("[data-animation]") ? n.attr("data-animation") : "fade-in";
            ...
            var o = new Waypoint({
                element: n[0], handler: function () {
                    if (n.parents(".wpb_tab").length > 0 && "hidden" == n.parents(".wpb_tab").css("visibility") || n.hasClass("animated-in")) o.destroy(); else {
                        if (!S || t('body[data-responsive="0"]').length > 0) {
                            var e = n.is("[data-delay]") ? n.attr("data-delay") : 0,
                                a = n.parents(".hover-wrap").length > 0 ? n.parents(".hover-wrap") : n, l = z;
                            n.parents(".nectar-disable-mobile-animation").length > 0 && pt.winW < 1e3 && (l = 0, r = 0, e = 0), "fade-in-from-left" == i || "fade-in-from-right" == i ? a.delay(e).transition({
                                ...
                                easing: s,
                                duration: l
                            })) : "fade-in" == i ? a.delay(e).transition({opacity: 1}, l, s) : "grow-in" == i ? setTimeout(function () {
            ...
            var e = t(this), a = t(this).is("[data-animation-timing]") ? t(this).attr("data-animation-timing") : 175;
            a = parseInt(a);
            var i = new Waypoint({
                element: e[0], handler: function () {
                    e.parents(".wpb_tab").length > 0 && "hidden" == e.parents(".wpb_tab").css("visibility") || e.hasClass("animated-in") ? i.destroy() : ((!S || t('body[data-responsive="0"]').length > 0) && (e.find(".cascading-image").each(function (e) {
                        ...
                        "flip-in" == n.attr("data-animation") || "flip-in-vertical" == n.attr("data-animation") ? setTimeout(function () {
                            n.find(".inner-wrap").css({opacity: 1, transform: "rotate(0deg) translateZ(0px)"})
                        }, e * a) : "grow-in-reveal" == n.attr("data-animation") ? setTimeout(function () {
                            n.find(".inner-wrap").css({
                                opacity: 1,
                                transform: "translateX(0px) translateY(0px) scale(1,1) translateZ(0px)"
                            }), n.find(".inner-wrap img").css({transform: "translateX(0px) translateY(0px) scale(1,1) translateZ(0px)"})
            ...
            var l = new Waypoint({
                element: i[0], handler: function () {
                    if (i.parents(".wpb_tab").length > 0 && "hidden" == i.parents(".wpb_tab").css("visibility") || i.hasClass("animated-in")) l.destroy(); else {
                        if (!S || t('body[data-responsive="0"]').length > 0) {
                            i.addClass("triggered-animation"), t(e).trigger("nectar-column-animation-start");
                            var a = i.attr("data-delay"), s = z;
                            if (i.hasClass("mobile-disable-entrance-animation") && pt.winW < 1e3 && (s = 0, o = 0, a = 0), "fade-in-from-left" == i.attr("data-animation") || "fade-in-from-right" == i.attr("data-animation")) K[n] = setTimeout(function () {
                            ...
                            }, a); else if ("fade-in-from-bottom" == i.attr("data-animation") || "slight-fade-in-from-bottom" == i.attr("data-animation")) {
                                ...
                                i.transition({rotateX: "0", y: "0", opacity: 1}, s, r)
            ...
            var n = t(this), s = new Waypoint({
                element: n[0], handler: function () {
                    if (n.parents(".wpb_tab").length > 0 && "hidden" == n.parents(".wpb_tab").css("visibility") || n.hasClass("animated-in")) s.destroy(); else {
                        ...
                        if (!S || t('body[data-responsive="0"]').length > 0) {
                            ...
                            "reveal-from-bottom" == n.attr("data-animation") || "reveal-from-top" == n.attr("data-animation") ? setTimeout(function () {
                                1 == i ? n.find("> .vc_column-inner").transition({y: 0}, z, e) : n.find(".column-inner-wrap, .column-inner").transition({y: 0}, z, e, function () {
                                ...
                                1 == i ? n.find("> .vc_column-inner").transition({x: 0}, z, e) : n.find(".column-inner-wrap, .column-inner").transition({x: 0}, z, e, function () {
                                    n.find(".column-inner-wrap, .column-inner").addClass("no-transform")
                                }), n.addClass("animated-in")
    ...
    function Xe() {
        t(ot + ".nectar-split-heading:not(.custom-trigger)").each(function (e) {
            ...
            var n = t(this), i = n.is("[data-animation-delay]") ? parseInt(n.attr("data-animation-delay")) : 0,
                s = new Waypoint({
                    element: n[0], handler: function () {
                        if (n.parents(".wpb_tab").length > 0 && "hidden" == n.parents(".wpb_tab").css("visibility") || n.hasClass("animated-in")) s.destroy(); else {
                            var e;
                            if (!S || t('body[data-responsive="0"]').length > 0) setTimeout(function () {
                                if (n.is('[data-animation-type="line-reveal-by-space"]:not([data-text-effect*="letter-reveal"])')) {
                                    ...
                                    t(this).find("> div").delay(70 * e).transition({y: "0px"}, z, O)
                                });
                                n.addClass("animated-in")
                            }, i);
                            s.destroy()
            ...
            if (!0 === ut.$usingFullScreenRows) var a = t(this), n = new Waypoint({
                element: a[0], handler: function () {
    ...
    function De() {
        ...
        pt.usingMobileBrowser && "bottom-in-view" == e && (e = "70%"), t(a).each(function () {
            var a = t(this), n = new Waypoint({
                element: a[0], handler: function () {
                    if (a.parents(".wpb_tab").length > 0 && "hidden" == a.parents(".wpb_tab").css("visibility") || a.hasClass("completed")) n.destroy(); else {
                        "100%" == e && a.find(".bar-wrap").css("opacity", "1");
                        var t = a.find("span").attr("data-width"), i = parseInt(a.find("span strong i").text());
                        a.find("span").transition({width: parseInt(t) + "%"}, 800, "easeInOutCubic");
                        var s = a.find("span strong i")[0];
                        new ae(s, 0, i, 0, 1, {useEasing: !1}).start(), a.find("span strong").transition({opacity: 1}, 550, "easeInCirc"), "100" == t && a.find("span strong").addClass("full"), a.addClass("completed"), n.destroy()
                    }
                }, offset: e
            })
        })
    ...
    function Ue() {
        ...
        t(ot + '.divider-small-border[data-animate="yes"], ' + ot + '.divider-border[data-animate="yes"]').each(function () {
            var a = t(this).hasClass("divider-small-border") ? 1300 : 1500, n = t(this), i = new Waypoint({
                element: n[0], handler: function () {
                    n.parents(".wpb_tab").length > 0 && "hidden" == n.parents(".wpb_tab").css("visibility") || n.hasClass("completed") ? i.destroy() : (n.each(function () {
                        t(this).css({transform: "scale(0,1)", visibility: "visible"});
                        var e = t(this);
                        e.delay(e.attr("data-animation-delay")).transition({transform: "scale(1, 1)"}, a, "cubic-bezier(.18,0.75,.25,1)")
        ...
        0 != t(".nectar_image_with_hotspots").length && (!function () {
            ...
            t('.nectar_image_with_hotspots:not([data-tooltip-func="click"]) .nectar_hotspot').each(function (a) {
                e[a] = "", t(this).on("mouseover", function () {
                    clearTimeout(e[a]), t(this).parent().css({"z-index": "400", height: "auto", width: "auto"})
                }), t(this).on("mouseleave", function () {
                    var n = t(this);
                    n.parent().css({"z-index": "auto"}), e[a] = setTimeout(function () {
            ...
            if (t(this).parents(".nectar_image_with_hotspots").find(".nttip").removeClass("open"), t(this).parent().find(".nttip").addClass("open"), t(this).parents(".nectar_image_with_hotspots").find(".nectar_hotspot").removeClass("open"), t(this).parent().find(".nectar_hotspot").addClass("open"), pt.winW > 690) {
                t(this).parent().css({"z-index": "120", height: "auto", width: "auto"});
                var e = t(this);
                setTimeout(function () {
            ...
            var a = t(this), n = new Waypoint({
                element: a[0], handler: function () {
                    a.parents(".wpb_tab").length > 0 && "hidden" == a.parents(".wpb_tab").css("visibility") || a.hasClass("completed") ? n.destroy() : (a.addClass("completed"), a.find(".nectar_hotspot_wrap").each(function (e) {
                        var a = t(this), n = a.parents(".col.has-animation").length > 0 ? 1 : 0;
                        setTimeout(function () {
                            a.addClass("animated-in")
                        }, 175 * (e + n))
                    }), n.destroy())
        ...
        if ("IntersectionObserver" in e) {
            s.off("resize.nectarLazySizing", sa), s.on("resize.nectarLazySizing", sa), ct = new IntersectionObserver(function (t) {
                t.forEach(function (t) {
                    if (t.isIntersecting) {
                        var e = t.target, a = e.getAttribute("data-nectar-img-src");
                        a && aa(e, a, ct)
                    }
                })
            }, {rootMargin: "450px"}), t.forEach(function (t) {
                ct.observe(t)
            });
            ...
            }, {root: jt() ? null : a, rootMargin: "125px"}), o = new IntersectionObserver(function (t, e) {
                t.forEach(function (t) {
                    na(t, o)
                })
            }, {rootMargin: "125px"});
    ...
    function sa() {
        t("img.nectar-lazy:not(.loaded):not(.image-gallery-portfolio-item)").each(function () {
            ...
            t(this).css({height: "", width: ""});
            var e = parseInt(t(this).attr("height")), a = parseInt(t(this).attr("width")),
    ...
    function da() {
        ...
        t(ot + ".nectar-post-grid-wrap").each(function () {
            if (!v || !t(this).hasClass("delay-js-loaded")) var a = t(this), n = new Waypoint({
                element: a[0], handler: function () {
                    if (a.parents(".wpb_tab").length > 0 && "hidden" == a.parents(".wpb_tab").css("visibility") || a.hasClass("completed")) n.destroy(); else {
                        ...
                        a.attr("data-style");
                        a.find(".nectar-post-grid__reveal-image__inner").length > 0 && a.find(".nectar-post-grid__reveal-image__inner").css({opacity: 0}), a.find(".nectar-post-grid-filters").addClass("animated-in"), a.find(".nectar-post-grid-item").each(function (a) {
                            var n = t(this);
                            setTimeout(function () {
            ...
            var a = t(this), n = new Waypoint({
                element: a[0], handler: function () {
                    a.parents(".wpb_tab").length > 0 && "hidden" == a.parents(".wpb_tab").css("visibility") || a.hasClass("animated-in") ? n.destroy() : (a.addClass("animated-in"), a.find(".flickity-cell").each(function (e) {
                        var a = t(this);
                        setTimeout(function () {
                            a.find("> .product").css({transform: "translate3d(0,0,0)", opacity: "1"})
                        }, 100 * e)
                    }), n.destroy())
                }, offset: e
            })
    ...
    function fa() {
        G = [], "undefined" != typeof NectarTestimonialSlider ? t(".testimonial_slider").each(function (e) {
            var a = t(this), n = t(this).is("[data-style]") ? t(this).attr("data-style") : "none";
    ...
    function ya() {
        t(".col.span_3, .vc_span3, .vc_col-sm-3").each(function () {
            if (!t(this).is('[data-t-w-inherits="small_desktop"]')) {
                var e = t(this), a = t(this).next("div");
    ...
    function ka() {
        ...
        t(".nectar-video-wrap").each(function () {
            ...
            if (0 != t(this).find("video").length) {
                ...
                } else if (t(this).hasClass("column-video")) if (r.is('[data-flex-cols="true"]')) {
                    var i = t(this).parents(".vc_column-inner");
                    a = i.outerHeight(), n = i.outerWidth()
                } else a = t(this).parents(".wpb_column").outerHeight(), n = t(this).parents(".wpb_column").outerWidth(); else {
                ...
                var o = n / 1280, l = (a - a) / 720, d = o > l ? o : l;
    ...
    function $a() {
        ...
        0 == t(".nectar-video-wrap").length && 0 == t(".nectar-youtube-bg").length || (setTimeout(function () {
            ka(), s.on("resize", ka), e.addEventListener("orientationchange", function () {
                ...
                if (0 != t(this).find("video").length) {
                    var e = t(this).parents("#page-header-bg").length > 0, a = t(this);
                    if (0 === t(this).find("video.nectar-lazy-video").length) var n = setInterval(function () {
                        a.find("video").get(0).readyState > 3 && (pt.usingMobileBrowser || (a.transition({opacity: "1"}, 400), a.find("video").transition({opacity: "1"}, 400), a.parent().find(".video-color-overlay").transition({opacity: "0.7"}, 400), 1 == e && Za()), p.addClass("loaded"), setTimeout(function () {
                            p.addClass("hidden")
                        }, 1e3), clearInterval(n))
                    }, 60);
                    pt.usingMobileBrowser && (a.parents(".full-width-section").length > 0 && 0 == a.parents("#nectar_fullscreen_rows").length && !a.hasClass("column-video") ? a.css("left", "50%") : a.css("left", "0px"), 1 == e && Za(), a.find("video")[0].onplay = function () {
                        a.transition({opacity: "1"}, 400), a.find("video").transition({opacity: "1"}, 400), a.parent().find(".video-color-overlay").transition({opacity: "0.7"}, 400)
                    })
                }
            })
    ...
    function Ta() {
        if (r.hasClass("single-post") && t(".content-inner[data-has-gallery]").length > 0 && (t(".wp-block-gallery").length > 0 ? t(".content-inner").find(".wp-block-gallery").each(function (e) {
            ...
            new Waypoint({
                element: t(".post-area")[0], handler: function (t) {
    ...
    function za() {
        t(".ocm-effect-wrap.material-ocm-open").length > 0 && (t(".ocm-effect-wrap").css({height: s.height()}), t(".ocm-effect-wrap-inner").css({"padding-top": pt.adminBarHeight}))
    }

    function Ha() {
        t('#slide-out-widget-area[class*="slide-out-from-right"] .off-canvas-menu-container li.menu-item-has-children').each(function () {
            t(this).find(".ocm-dropdown-arrow").css({top: t(this).find("a").height() / 2})
    ...
    function Ma() {
        ...
        (pt.usingMobileBrowser || t(".slide-out-from-right-hover.ios-ocm-style").length > 0) && (t(".slide-out-widget-area-toggle a").attr("aria-expanded", "true"), l.css({
            height: "100%",
            width: "100%"
        })), o.css({transform: "translate3d(0,0,0)"}).addClass("open"), Sa(), t(".slide-out-from-right-hover.ios-ocm-style").length > 0 && setTimeout(function () {
        ...
        if (t("header#top .container .span_9 > .slide-out-widget-area-toggle").length > 0) {
            ...
            if (t('#header-outer[data-format="centered-menu-bottom-bar"]').length > 0 && (u = !1), t("body.mobile").length > 0 || u || "left" === A) c.css({top: t("header#top .span_9 > .slide-out-widget-area-toggle a").offset().top - pt.scrollTop}), "left" === n || "left" === A ? c.css({
    ...
    function ja() {
        if (r.on("click", ".slide-out-widget-area-toggle:not(.std-menu) a.closed.animating", function () {
            ...
            return gt.ocmOpen = !0, Sa(), d.removeClass("no-transition"), t(this).hasClass("simple-mobile-menu") ? (La("simple-mobile-menu"), t(this).find("a").addClass("open"), !1) : (o.hasClass("slide-out-from-right") ? function () {
                var a = f.length > 0 && 0 == t("body.mobile").length ? f.height() : 0, n = Ut();
                pt.winW < 1e3 && (n = !0);
                ...
                if (0 == t("body.material").length) {
                    ...
                    }), t('#slide-out-widget-area[data-dropdown-func="separate-dropdown-parent-link"] .inner > div:first-of-type > .menu > li:first-child').length > 0 && t("#slide-out-widget-area .inner > div:first-of-type > .menu > li:first-child").hasClass("menu-item-has-children") && t("#slide-out-widget-area .inner > div:first-of-type").css({"margin-top": "50px"}), 0 == t("#boxed").length) {
                        t(".container-wrap, .home-wrap, #footer-outer:not(#nectar_fullscreen_rows #footer-outer), .nectar-box-roll, #page-header-wrap .page-header-bg-image, #page-header-wrap .nectar-video-wrap, #page-header-wrap .mobile-video-image, #page-header-wrap #page-header-bg > .container, .page-header-no-bg, div:not(.container) > .project-title").stop(!0).transition({x: "left" === i || "left" === A ? "300px" : "-300px"}, 700, "easeInOutCubic");
                        var h = Ut();
                        0 == t('#header-outer[data-format="centered-logo-between-menu"]').length || h ? 0 == t('#header-outer[data-transparency-option="1"]').length || t('#header-outer[data-transparency-option="1"]').length > 0 && 0 == t('#header-outer[data-full-width="true"]').length || t("body.mobile").length > 0 ? d.stop(!0).css("transform", "translateY(0)").transition({x: "left" === i || "left" === A ? 300 + a + "px" : "-" + (300 + a) + "px"}, 700, "easeInOutCubic") : d.stop(!0).css("transform", "translateY(0)").transition({
                            x: "left" === i || "left" === A ? 300 + a + "px" : "-" + (300 + a) + "px",
                            "background-color": "transparent",
                            "border-bottom": "1px solid rgba(255,255,255,0.22)"
                        }, 700, "easeInOutCubic") : t('#header-outer header#top nav > ul.buttons, body:not(.material) #header-outer:not([data-format="centered-logo-between-menu"]) .cart-outer .cart-menu-wrap').transition({x: "left" === i || "left" === A ? "300px" : "-300px"}, 700, "easeInOutCubic")
                    }
                    if (o.stop(!0).transition({x: "left" === i || "left" === A ? a + "px" : "-" + a + "px"}, 700, "easeInOutCubic").addClass("open"), 0 == t("#boxed").length && t('#header-outer[data-full-width="true"]').length > 0 && !r.hasClass("mobile") && (d.addClass("highzI"), t("#ascrail2000").addClass("z-index-adj"), 0 == t('#header-outer[data-format="centered-logo-between-menu"]').length && 0 == b && ("left" === A || t("header#top #logo").stop(!0).transition({x: 300 + a + "px"}, 700, "easeInOutCubic")), t("header#top .slide-out-widget-area-toggle .lines-button:not(.legacy-double)").addClass("close"), t("body #header-outer nav > ul > li > a").css({"margin-bottom": "0"})), d.addClass("style-slide-out-from-right"), l.css({
                        height: "100%",
                        width: "100%"
                    }).stop(!0).transition({opacity: 1}, 700, "easeInOutCubic", function () {
                    ...
                    0 == t('#header-outer[data-remove-fixed="1"]').length && pt.winW > 1e3 && (1 == dt && 1 == k && "true" == d.attr("data-transparent-header") ? (d.stop(!0).transition({y: "0"}, 0).addClass("transparent").css("transition", "transform"), s.off("scroll", gn), s.off("scroll", fn)) : 1 == dt && "true" == d.attr("data-transparent-header") && (d.addClass("transparent"), s.off("scroll", mn), s.off("scroll", vn)))
                    ...
                    position: "relative",
                    top: "-" + pt.scrollTop + "px"
                }), t(".ocm-effect-wrap-inner").css({"padding-top": pt.adminBarHeight}), t("#fp-nav").addClass("material-ocm-open"), gt.materialOffCanvasOpen = !0, r.addClass("material-ocm-open"), r.addClass("nectar-no-flex-height"), t(".ocm-effect-wrap").css({height: pt.winH}), setTimeout(function () {
                ...
                var e = 0, a = 0;
                pt.scrollTop + s.height() > t(".blurred-wrap").height() && 0 == t("#nectar_fullscreen_rows").length && (t("body,html").stop().animate({scrollTop: t(".blurred-wrap").height() - s.height()}, 600, "easeInOutCubic"), e = 550, a = 200), t("header#top .slide-out-widget-area-toggle:not(.std-menu) .lines-button:not(.legacy-double)").addClass("close"), setTimeout(function () {
                    ...
                    t(".off-canvas-menu-container .menu > li").each(function (e) {
                        t(this).delay(50 * e).transition({y: 0, opacity: 1}, 800, "easeOutExpo")
                    }), t("#slide-out-widget-area.fullscreen .widget").each(function (e) {
                        t(this).delay(100 * e).transition({y: 0, opacity: 1}, 800, "easeOutExpo")
                    })
                    ...
                    t("#slide-out-widget-area .off-canvas-social-links").addClass("line-shown"), t("#slide-out-widget-area .off-canvas-social-links li").each(function (e) {
                        t(this).delay(50 * e).transition({scale: 1}, 400, "easeOutCubic")
                    }), t("#slide-out-widget-area .bottom-text").transition({opacity: .7}, 400, "easeOutCubic")
                }, 750 + a), setTimeout(function () {
                    var e = t("body.mobile").length > 0 ? "easeOutCubic" : "easeInOutQuint";
                    l.css({height: "100%", width: "100%"}).show().stop(!0).transition({y: "0%"}, 920, e, function () {
                ...
                o.hasClass("fullscreen-split") && (e = ".fullscreen-split"), t("body.material").length > 0 && t("header#top .slide-out-widget-area-toggle a").addClass("menu-push-out"), t("header#top .slide-out-widget-area-toggle:not(.std-menu) .lines-button:not(.legacy-double)").addClass("close"), ".fullscreen-alt" === e ? t("#slide-out-widget-area" + e).show().addClass("open") : t("#slide-out-widget-area" + e).addClass("open").removeClass("hidden"), l.addClass("open").removeClass("hidden"), t('body > div[class*="body-border"]').css("z-index", "9995"), ".fullscreen-alt" === e && t(".off-canvas-menu-container .menu").transition({
                    ...
                    t(".off-canvas-menu-container .menu > li").each(function (e) {
                        ...
                        t(this).delay(100 * e).transition({y: 0, opacity: 1}, 650, "easeOutCubic")
                    })
                    ...
                    t("#slide-out-widget-area .off-canvas-social-links").addClass("line-shown"), t("#slide-out-widget-area .off-canvas-social-links li").css("opacity", "1").each(function (e) {
                        t(this).delay(50 * e).transition({scale: 1}, 400, "easeOutCubic")
                    }), t("#slide-out-widget-area .bottom-text").transition({opacity: 1}, 600, "easeOutCubic")
                }, 200));
                var a = .4;
            ...
            if (null != a.originalEvent || 0 != t(".slide_out_area_close.non-human-allowed").length || 0 != t(".slide-out-widget-area-toggle.mobile-icon a.non-human-allowed").length) return !(gt.ocmAnimating || t(".slide-out-widget-area-toggle:not(.std-menu) a.animating").length > 0) && (gt.ocmOpen = !1, d.removeClass("no-transition"), t(this).parents(".simple-mobile-menu").length > 0 ? (qa("simple-mobile-menu"), t(this).removeClass("open"), !1) : (t(".slide-out-widget-area-toggle:not(.std-menu):not(.simple-mobile-menu) a").removeClass("open").addClass("closed").attr("aria-expanded", "false"), t(".slide-out-widget-area-toggle:not(.simple-mobile-menu):not(.std-menu) a").addClass("animating"), o.hasClass("slide-out-from-right") ? function () {
                if (0 == t("body.material").length) {
                    ...
                    pt.winW < 1e3 && (a = !0);
                    var n = e.nectarOptions && e.nectarOptions.mobile_header_format && "centered-menu" === e.nectarOptions.mobile_header_format && a ? "left" : "right";
                    if (t(".container-wrap, .home-wrap, #footer-outer:not(#nectar_fullscreen_rows #footer-outer), .nectar-box-roll, #page-header-wrap .page-header-bg-image,  #page-header-wrap .nectar-video-wrap, #page-header-wrap .mobile-video-image, #page-header-wrap #page-header-bg > .container, .page-header-no-bg, div:not(.container) > .project-title").stop(!0).transition({x: "0px"}, 700, "easeInOutCubic"), t('#header-outer[data-transparency-option="1"]').length > 0 && 0 == t("#boxed").length) {
                        var i = t("#header-outer[data-current-row-bg-color]").length > 0 ? d.attr("data-current-row-bg-color") : d.attr("data-user-set-bg");
                        d.stop(!0).transition({x: "0px", "background-color": i}, 700, "easeInOutCubic")
                    } else d.stop(!0).transition({x: "0px"}, 700, "easeInOutCubic");
                    o.stop(!0).transition({x: "left" === n || "left" === A ? "-301px" : "301px"}, 700, "easeInOutCubic").removeClass("open"), 0 == t("#boxed").length && t('#header-outer[data-full-width="true"]').length > 0 && (d.removeClass("highzI"), t("header#top #logo").stop(!0).transition({x: "0px"}, 700, "easeInOutCubic"), t(".lines-button").removeClass("close")), t('#header-outer[data-format="centered-logo-between-menu"]').length > 0 && t("#header-outer header#top nav > ul.buttons, #header-outer .cart-outer .cart-menu-wrap").stop(!0).transition({x: "0px"}, 700, "easeInOutCubic"), l.stop(!0).transition({opacity: 0}, 700, "easeInOutCubic", function () {
                    ...
                    t(".slide-out-widget-area-toggle a").removeClass("animating"), r.removeClass("material-ocm-open"), r.removeClass("nectar-no-flex-height"), t(".ocm-effect-wrap").css({height: "100%"}), t(".ocm-effect-wrap-inner").css({"padding-top": "0"}), s.scrollTop(Math.abs(parseInt(t("#ajax-content-wrap").css("top")))), t("#ajax-content-wrap").css({
                        position: "",
                        top: ""
                    }), t('#header-outer[data-format="centered-menu-bottom-bar"]').length > 0 && "none" != t('#header-outer[data-format="centered-menu-bottom-bar"] .span_9').css("display") && 0 == t("body.mobile").length && (t("#header-outer:not(.fixed-menu)").css("top", ""), c.css("visibility", "")), t('body[data-hhun="1"]:not(.no-scroll) #header-outer[data-permanent-transparent="false"]:not(.detached):not(.parallax-contained):not(.at-top-before-box)').css({transform: ""}), setTimeout(function () {
                        t('body[data-hhun="1"]:not(.no-scroll) #header-outer[data-permanent-transparent="false"]:not(.detached):not(.parallax-contained):not(.at-top-before-box)').css({transition: ""})
            ...
            }, 350), t(".slide-out-widget-area-toggle:not(.std-menu) .lines-button:not(.legacy-double)").removeClass("close"), t(".blurred-wrap").removeClass("blurred"), t("#slide-out-widget-area.fullscreen").transition({opacity: 0}, 700, "easeOutQuad", function () {
                t("#slide-out-widget-area.fullscreen").hide().css("opacity", "1")
            }).removeClass("open"), t("#slide-out-widget-area.fullscreen .widget").transition({opacity: 0}, 700, "easeOutQuad", function () {
                t(this).transition({y: "110px"}, 0)
            }), setTimeout(function () {
                t(".off-canvas-menu-container .menu > li").transition({
                    y: "80px",
                    opacity: 0
                }, 0), t("#slide-out-widget-area .off-canvas-social-links li").transition({scale: 0}, 0), t("#slide-out-widget-area .off-canvas-social-links").removeClass("line-shown"), t("#slide-out-widget-area .bottom-text").transition({opacity: 0}, 0), t("#slide-out-widget-area .menuwrapper .menu").removeClass("subview"), t("#slide-out-widget-area .menuwrapper .menu li").removeClass("subview subviewopen"), t("#slide-out-widget-area.fullscreen .inner .menu-wrap").css("height", "auto")
            }, 800), setTimeout(function () {
                0 == t(".nectar-social.fixed").length && Nn(), t(".container-wrap").removeClass("no-shadow")
            }, 500), l.stop(!0).transition({opacity: 0}, 900, "easeOutQuad", function () {
            ...
            }, 550), ".fullscreen-alt" === n && (t(".blurred-wrap").removeClass("blurred"), t("#slide-out-widget-area.fullscreen-alt .widget").transition({opacity: 0}, 500, "easeOutQuad", function () {
                t(this).transition({y: "40px"}, 0)
            }), t("#slide-out-widget-area .bottom-text, #slide-out-widget-area .off-canvas-social-links li").transition({opacity: 0}, 250, "easeOutQuad"), t("#slide-out-widget-area .off-canvas-social-links").removeClass("line-shown"), t(".off-canvas-menu-container .menu").transition({
                y: "-13px",
                opacity: 0
                ...
                ".fullscreen-alt" === n && (t(".off-canvas-menu-container .menu > li").stop(!0, !0).transition({
                    y: "40px",
                    opacity: 0
                }, 0), t("#slide-out-widget-area .off-canvas-social-links li").transition({scale: 0}, 0), t("#slide-out-widget-area .off-canvas-social-links").removeClass("line-shown"), t("#slide-out-widget-area .menuwrapper .menu").removeClass("subview"), t("#slide-out-widget-area .menuwrapper .menu li").removeClass("subview subviewopen"), t("#slide-out-widget-area.fullscreen-alt .inner .menu-wrap").css("height", "auto"), l.css({
                    height: "1px",
                    width: "1px",
                    left: "-100%"
                ...
                ".fullscreen-alt" === n && l.stop(!0).css({opacity: 0}), t('#header-outer[data-transparent-header="true"]').length > 0 && t('body > div[class*="body-border"]').css("z-index", "10000")
    ...
    oe.prototype.setup = function () {
        ...
        var t = this, e = this.$el.find(".dynamic-words").width();
        this.$el.find(".dynamic-words").css({width: ""});
        var a = this.words[this.state.activeIndex].find("span").width();
        this.$el.find(".dynamic-words").css({width: e}), setTimeout(function () {
        ...
        }), this.$el.hasClass("animated-in") && this.$el.find(".beginning-text .inner, .ending-text .inner").css({transform: "translateY(0)"}), this.$el.addClass("markup-generated");
        var n = 1 == lt ? "500%" : "bottom-in-view", i = this.$el,
            s = i.is("[data-delay]") ? parseInt(i.attr("data-delay")) : 0, r = new Waypoint({
                element: i[0], handler: function () {
                    if (i.parents(".wpb_tab").length > 0 && "hidden" == i.parents(".wpb_tab").css("visibility") || i.hasClass("animated-in")) r.destroy(); else {
                        if (!S || t('body[data-responsive="0"]').length > 0) setTimeout(function () {
                            var e = 0;
                            ...
                            i.find(".text-wrap").each(function () {
                                var n = t(this);
                                if (t(this).parents(".dynamic-words").length > 0 && !t(this).hasClass("active")) return n.find("> span").css({transform: "translate3d(0,0,0)"}), !0;
                                setTimeout(function () {
        ...
        if (!(pt.usingMobileBrowser && pt.winW < 1e3) && "IntersectionObserver" in e) {
            ...
            this.observer = new IntersectionObserver(function (e) {
                e.forEach(function (e) {
                    var a = "#" + t(e.target).attr("id"), i = n.$el.find('.scrolling-tab-nav a[href="' + a + '"]');
        ...
        if (0 != t.length) {
            var e = parseInt(t.position().top), a = parseInt(t.height());
            this.$lineEl.css({"max-height": a + "px", transform: "translate3d(0px, " + e + "px, 0px)"})
        }
        ...
        if (!pt.usingFrontEndEditor && "IntersectionObserver" in e) {
            ...
            }, {root: jt() ? null : a, rootMargin: "400px 0px 400px 0px", threshold: 0});
            n.observe(this.$el[0])
        } else this.init()
    }, ge.prototype.calcTopOffset = function () {
        this.topOffset = (pt.winH - this.$innerEl.height()) / 2
    }, ge.prototype.resizeEvent = function () {
        pt.winW > 1e3 ? (this.calcTopOffset(), this.$innerEl.css({top: this.topOffset})) : this.$innerEl.css({top: ""})
        ...
        if (void 0 !== this.timelines[this.activeDevice]) {
            var t = pt.scrollTop, e = this.storedWinH, a = parseInt(this.offsets.start) / 100, n = e - a * e;
            ...
            var s = Math.max(Math.min(i, 1), 0), r = parseInt(this.offsets.end) / 100, o = 2 + -1 * r, l = r - a - .01;
        ...
        }, {root: jt() ? null : a, rootMargin: "100px 0px 100px 0px", threshold: 0}).observe(this.$el[0]);
        ...
        var e = Zt(), a = this.el.find(".nectar-post-grid-link.pretty_photo").length > 0;
        ...
        var a = this.settingsData, n = this.queryData, i = this;
        this.el.find(".nectar-post-grid-filters a, .load-more-wrap .load-more").on("click", function (r) {
            ...
            var l = o.parents(".nectar-post-grid-wrap").find(".nectar-post-grid"), d = a.pagination,
                c = o.hasClass("load-more") && "load-more" === d ? "load-more" : "filter", h = "", u = "";
            if ("yes" === i.sortable) h = o.parents(".nectar-post-grid-wrap").find(".nectar-post-grid-filters a.active").attr("data-filter"), u = o.parents(".nectar-post-grid-wrap").find(".nectar-post-grid-filters a.active").attr("data-filter"); else {
            ...
            "rand" == n.orderby && "load-more" == c && (f.posts_shown = "", l.find(".nectar-post-grid-item[data-post-id]").each(function () {
                ...
                if ("load-more" === c) l.append(n); else if (l.html(n), l.parent().hasClass("nectar-post-grid-wrap--fl-sidebar_left") || l.parent().hasClass("nectar-post-grid-wrap--fl-sidebar_right")) {
                    var r = l.parent().offset().top, h = 0;
        ...
        void 0 !== ee["grid-filter"] && this.el.find(".nectar-post-grid-filters a").each(function () {
            var e = t(this).clone(), a = ee["grid-filter"];
            t(this);
        ...
        _init: function (e) {
            ...
            this.$trigger.on("click.menu", function () {
                ...
                var n = t(this).parent("li"), i = n.children("ul.sub-menu");
                if (t(".fullscreen-alt .off-canvas-menu-container .clip-wrap, .fullscreen-alt .off-canvas-menu-container .clip-wrap span").css("transition-duration", "0s"), i.length > 0) {
                    var s = i.clone().css("opacity", 0).insertAfter(e.$menu), r = function () {
                    ...
                    }), n.parents(".menu-wrap").css("height", n.parents(".off-canvas-menu-container").find(".menuwrapper .menu").height()).transition({height: s.height()}, 500, "easeInOutQuad"), setTimeout(Aa, 600), !1
                }
                e.options.onLinkClick(n.find("> a"), a), Ra(n)
            }), this.$back.on("click.menu", function () {
                var a = t(this), n = a.parents("ul.sub-menu:first"), i = n.parent(), s = n.clone().insertAfter(e.$menu),
                    r = function () {
                ...
                return setTimeout(function () {
                    ...
                    i.parents(".menu-wrap").transition({height: i.parent().height()}, 500, "easeInOutQuad"), setTimeout(Aa, 600)
                }, 50), !1
            })
        }, closeMenu: function () {
    ...
    function Da() {
        0 != t("#ajax-content-wrap").length && r.hasClass("ajax-loaded") ? 1 == t("#ajax-content-wrap").length && t('#page-header-bg[data-parallax="1"]').css({opacity: 1}) : t('#page-header-bg[data-parallax="1"]').animate({opacity: 1}, 350, "easeInCubic"), t('#page-header-bg[data-parallax="1"] .nectar-particles').append('<div class="fade-out" />')
    }

    function Qa() {
        var a = {inView: !0}, n = t("#page-header-bg .span_6 .inner-wrap"), i = t("#page-header-bg #canvas");
        if (t('#page-header-bg[data-parallax="1"]').length > 0) {
            var r = new Image, o = parseInt(g.height()), l = t("#header-space").height(),
        ...
        function p() {
            ...
            }), i && i.css({transform: "translateY(" + .15 * pt.scrollTop * 2 + "px)"})), pt.scrollTop / (o + l + pt.adminBarHeight) > 1 ? (a.inView = !1, t(".nectar-particles, #page-header-bg .fade-out").css("visibility", "hidden").addClass("out-of-sight"), t("#page-header-bg").addClass("out-of-sight")) : (a.inView = !0, t("#page-header-bg, .nectar-particles, #page-header-bg .fade-out").css("visibility", "visible").removeClass("out-of-sight")))
        }
        ...
        g.length > 0 && ((-1 != navigator.userAgent.indexOf("Safari") && -1 == navigator.userAgent.indexOf("Chrome") || navigator.userAgent.match(/(iPod|iPhone|iPad)/)) && (e.onunload = function () {
            Qa(), t('#page-header-bg[data-parallax="1"] .span_6').css({opacity: 1})
    ...
    function Za() {
        if (0 == t("#page-header-bg .nectar-particles").length && 0 == t('#page-header-bg[data-text-effect="none"]').length || t(".nectar-box-roll").length > 0 && 0 == t("#page-header-bg .nectar-particles").length) {
            ...
            t(e).find(".wraped").each(function (e) {
                t(this).find("span").delay(370 * e).transition({rotateX: "0", opacity: 1, y: 0}, 400, "easeOutQuad")
            }), setTimeout(function () {
                t(e).find(".inner-wrap > *:not(.top-heading)").each(function (e) {
                    t(this).delay(370 * e).transition({rotateX: "0", opacity: 1, y: 0}, 650, "easeOutQuad")
        ...
        if (t('#header-outer[data-permanent-transparent="1"]').length > 0 && t('body[data-bg-header="true"]').length > 0) {
            ...
            t("div[data-midnight]:not(.has-global-section)").each(function () {
                ...
                if ("light" == n.attr("data-midnight") || "dark" == n.attr("data-midnight")) {
                    var i = n;
                    new Waypoint({
                        element: i[0], handler: function (n) {
                            var s;
    ...
    function Ka() {
        ...
        a = 1 == lt ? "500%" : "93%", i = 1 == lt ? "500%" : "95%", t(ot + '.row-bg-wrap[data-bg-animation]:not([data-bg-animation="none"]) .row-bg').each(function () {
            ...
            var r = t(this), o = new Waypoint({
                element: r.parents(".row-bg-wrap")[0], handler: function () {
            ...
            var a = t(this), n = new Waypoint({
                element: a.parents(".column-image-bg-wrap")[0], handler: function () {
            ...
            o = c;
            var e = t(this), a = t(this).attr("data-bg-animation");
            ...
            var e = t(this), a = new Waypoint({
                element: e[0], handler: function () {
                    e.parents(".wpb_tab").length > 0 && "hidden" == e.parents(".wpb_tab").css("visibility") || e.hasClass("animated-in") ? a.destroy() : (e.find("> div").each(function (e) {
                        t(this).delay(80 * e).transition({opacity: "1"}, 450)
                    }), setTimeout(function () {
            ...
            if ("false" == a.attr("data-animation") && (n = 1, a.css("opacity", "1")), a.hasClass("bound") || (W[e] = new Vivus(a.find("svg").attr("id"), {
                ...
                duration: n,
                onReady: function () {
                    a.css({height: parseInt(a.attr("data-size")) + "px", width: parseInt(a.attr("data-size")) + "px"})
                }
            ...
            var a = 0;
            t(this).is("[data-animation-delay]") && t(this).attr("data-animation-delay").length > 0 && "false" != t(this).attr("data-animation") && (a = t(this).attr("data-animation-delay"));
            var n = t(this), i = n.find("svg").attr("id").replace(/[^0-9]/g, "");
            ...
            if (t(".nectar-milestone").each(function () {
                ...
                t(ot + ".nectar-milestone.motion_blur").each(function (a) {
                    ...
                    var n = t(this).find(".number").css("color"), i = parseInt(n.substring(1), 16),
                        s = (16711680 & i) >> 16, r = (65280 & i) >> 8, o = (255 & i) >> 0,
                        l = "rgba(" + s + "," + r + "," + o + ",0.2)", d = "rgba(" + s + "," + r + "," + o + ",1)",
                    ...
                    if (e += "@keyframes motion-blur-number-" + a + " {  0% { opacity: 0;color: " + l + "; text-shadow: 0 " + c / 20 + "px 0 " + l + ", 0 " + c / 10 + "px 0 " + l + ", 0 " + c / 6 + "px 0 " + l + ", 0 " + c / 5 + "px 0 " + l + ", 0 " + c / 4 + "px 0 " + l + ", 0 -" + c / 20 + "px 0 " + l + ", 0 -" + c / 10 + "px 0 " + l + ", 0 -" + c / 6 + "px 0 " + l + ", 0 -" + c / 5 + "px 0 " + l + ", 0 -" + c / 4 + "px 0 " + l + "; transform: translateZ(0px) translateY(-100%); -webkit-transform: translateZ(0px) translateY(-100%); } 33% { opacity: 1 }100% { color: " + d + "; text-shadow: none; transform: translateZ(0px) translateY(0px); -webkit-transform: translateZ(0px) translateY(0px); } } @-webkit-keyframes motion-blur-number-" + a + " {  0% { opacity: 0;color: " + l + "; text-shadow: 0 " + c / 20 + "px 0 " + l + ", 0 " + c / 10 + "px 0 " + l + ", 0 " + c / 6 + "px 0 " + l + ", 0 " + c / 5 + "px 0 " + l + ", 0 " + c / 4 + "px 0 " + l + ", 0 -" + c / 20 + "px 0 " + l + ", 0 -" + c / 10 + "px 0 " + l + ", 0 -" + c / 6 + "px 0 " + l + ", 0 -" + c / 5 + "px 0 " + l + ", 0 -" + c / 4 + "px 0 " + l + "; transform: translateZ(0px) translateY(-100%); -webkit-transform: translateZ(0px) translateY(-100%); } 33% { opacity: 1 }100% { color: " + d + "; text-shadow: none; transform: translateZ(0px) translateY(0px); -webkit-transform: translateZ(0px) translateY(0px); } } .nectar-milestone.motion_blur.instance-" + a + " .number span.in-sight { animation: 0.65s cubic-bezier(0, 0, 0.17, 1) 0s normal backwards 1 motion-blur-number-" + a + "; -webkit-animation: 0.65s cubic-bezier(0, 0, 0.17, 1) 0s normal backwards 1 motion-blur-number-" + a + "; } ", 0 != ut.$usingFullScreenRows || 0 == t(this).find(".number > span").length) {
                        ...
                        var u = t(this).find(".number").text().split(""), p = t(this).find(".number");
            ...
            var e = 1 == lt ? "200%" : "bottom-in-view", a = 0;
            t(this).is("[data-animation-delay]") && t(this).attr("data-animation-delay").length > 0 && "false" != t(this).attr("data-animation") && (a = t(this).attr("data-animation-delay"));
            var n = t(this), i = new Waypoint({
                element: n[0], handler: function () {
                    n.parents(".wpb_tab").length > 0 && "hidden" == n.parents(".wpb_tab").css("visibility") || n.hasClass("animated-in") ? i.destroy() : (setTimeout(function () {
                        n.find(".owl-stage > .owl-item").each(function (e) {
                            t(this).delay(200 * e).transition({opacity: "1", y: "0"}, 600, "easeOutQuart")
                        }), n.addClass("animated-in")
                    }, a), i.destroy())
                }, offset: e
            })
            ...
            if (t('body[data-header-inherit-rc="true"]').length > 0 && 0 == t(".mobile").length && t('#header-outer[data-transparent-header="true"]').length > 0) {
                ...
                0 == t('#header-outer[data-permanent-transparent="1"]').length && (e = w - _ + Math.ceil(2 * y / 1.8) + pt.adminBarHeight), t(".main-content > .row > .wpb_row").each(function () {
                    var a, n = t(this);
                    new Waypoint({
                        element: n[0], handler: function (e) {
        ...
        }(), Ce(), Qe(), Ge(), re(), da(), function () {
            if (st.length > 0) for (var e = 0; e < st.length; e++) clearInterval(st[e].interval);
    ...
    function tn() {
        ...
        wt(), Ct(), setTimeout(xt, 100), It(), Ht(), Wt(), Ft(), qt(), fe(), r.on("click", ".toggle > h3 a, .toggle > .toggle-title a", function () {
            ...
            if (0 == t(this).parents('.toggle[data-inner-wrap="true"]').length) i.find(".toggle > div").slideUp(300), i.find(".toggle h3 a i").attr("class", "fa fa-plus-circle"), i.find(".toggle").removeClass("open"), r.find("> div").slideDown(300), r.addClass("open"); else {
            ...
            if (!(t(".nectar_team_member_overlay").length > 0)) {
                var a = t("body > #boxed").length > 0 ? "in-boxed" : "", n = t(this).find(".nectar_team_bio").html(),
                ...
                if (c = t(this).is('[data-style="bio_fullscreen_alt"]') ? '<div class="title">' + Vt(i) + "</div><h2>" + t(this).find(".team-meta h3").text() + "</h2>" : "<h2>" + t(this).find(".team-meta h3").text() + '</h2><div class="title">' + Vt(i) + "</div>", r.append('<div class="nectar_team_member_overlay ' + a + '" data-style="' + l + '"><div class="inner-wrap"><div class="team_member_details"><div class="bio-inner"><span class="mobile-close"></span>' + c + '<div class="team-desc">' + Vt(n) + '</div></div></div><div class="team_member_picture"><div class="team_member_image_bg_cover"></div><div class="team_member_picture_wrap"><div class="team_member_image"></div></div></div></div></div>'), o.length > 0) {
                    ...
                    }, t(".nectar_team_member_overlay .team_member_image").css({"background-image": 'url("' + o + '")'})
                }
                var u = t('body[data-header-format="left-header"]').length > 0 && s.width() > 1e3 ? 0 : d.height();
                t(".nectar_team_member_overlay .inner-wrap").css({"padding-top": u}), t(".using-mobile-browser").length > 0 && t("body,html").addClass("nectar-no-scrolling"), ye(), t(".nectar_team_member_overlay").addClass("open").addClass("animating"), setTimeout(function () {
        ...
        }), r.on("click", ".mobile-close", function (e) {
            ...
            t('.page-submenu[data-sticky="true"]').length > 0 && 0 == t("#nectar_fullscreen_rows").length && (!function () {
                ...
                s.on("smartresize", function () {
                    ...
                    n = Xt(), this.topLevel && t('body[data-hhun="1"] #header-outer.detached:not(.invisible)').length > 0 && (n += 1, this.$element.css({"margin-top": "-1px"})), u.length > 0 && "fixed" == u.css("position") && (n += u.height()), f.length > 0 && s.width() > 1e3 && t('body[data-hhun="1"]').length > 0 && (n += f.height()), this.waypoint = new a(t.extend({}, this.options, {
                        element: this.wrapper,
                        handler: t.proxy(function (a) {
                            var i = this.options.direction.indexOf(a) > -1, r = i ? this.$element.outerHeight(!0) : "";
                            if (this.$wrapper.height(r), i) {
                                var o = 0;
                                if (this.topLevel && t('body[data-hhun="1"] #header-outer.detached:not(.invisible)').length > 0) {
                                    var l = d.outerHeight(), h = 0;
                ...
                if (t(this).parents(".span_12").find("> .wpb_column").length > 1) {
                    var a = t(this).clone(), n = t(this).parents(".wpb_row");
            ...
            function e() {
                t('.blog-recent[data-style="title_only"]').each(function () {
                    ...
                    if (e.hasClass("vc_col-sm-3") || e.hasClass("vc_col-sm-4") || e.hasClass("vc_col-sm-6") || e.hasClass("vc_col-sm-8") || e.hasClass("vc_col-sm-9")) if (0 == t("body.mobile").length && 0 == t(this).next("div").length) {
                        var a = 0;
            ...
            if (t(".portfolio-items .col .style-3-alt").length > 0 || t(".portfolio-items .col .style-3").length > 0 || t(".portfolio-items .col .style-2").length > 0 || t(".portfolio-items .col .style-5").length > 0) {
                ...
                t(".portfolio-items .col").each(function () {
                    var a = t(this).attr("data-title-color"), n = t(this).attr("data-subtitle-color");
            ...
            if (1 == t(".single-portfolio #sidebar").attr("data-follow-on-scroll") && !r.hasClass("mobile") && parseInt(t("#sidebar").height()) + 50 <= parseInt(t(".post-area").height())) {
                var e = ai();
                t(".single-portfolio #sidebar").theiaStickySidebar({additionalMarginTop: e, updateSidebarHeight: !1})
            }
    ...
    function en() {
        this.$toggleBtn = t(".nectar-shop-filters .nectar-shop-filter-trigger"), this.$sidebar = t("#sidebar"), this.sidebarPos = this.$sidebar.hasClass("col_last") ? "right" : "left", this.state = {open: this.getLS() ? this.getLS() : "true"}, this.setup(), this.events()
    }
    ...
    function nn() {
        this.state = {processing: !1, productID: !1, type: "regular"}, this.events()
    }

    function sn() {
        var n;
        r.on("click", ".product .add_to_cart_button", function () {
            var e = t(this).parents("li").find("h2").length > 0 ? "h2" : "h3", a = t(this).parents("li").find(e).text();
        ...
        if (t(".products .classic .product-wrap .add_to_cart_button").wrapInner("<span />"), t(".products .classic .product-wrap .add_to_cart_button").prepend('<i class="normal icon-salient-cart"></i>'), !(t('.products[data-rm-m-hover="1"]').length > 0 && pt.usingMobileBrowser) && e.nectarOptions && e.nectarOptions.woo_minimal_product_effect && "default" === e.nectarOptions.woo_minimal_product_effect && (r.on("mouseover", ".products .minimal.product", function () {
            var e, a, n, i, s, r;
            e = t(this), n = (a = e).width(), i = a.height(), s = (parseInt(n) + 40) / parseInt(n), r = (parseInt(i) + 40) / parseInt(i), a.addClass("hover-bound"), a.find(".background-color-expand").css({transform: "scale(" + s + "," + r + ") translateY(0px) translateZ(0px)"})
        }), r.on("mouseleave", ".products .minimal.product", function () {
            t(this).find(".background-color-expand").css({transform: "scale(1, 1) translateY(0) translateZ(0px)"})
    ...
    function ln() {
        t('#header-outer[data-format="centered-menu-bottom-bar"]').length > 0 && function () {
            var e = d, a = t('#header-outer[data-format="centered-menu-bottom-bar"] header#top .span_9'),
                n = t('#header-outer[data-format="centered-menu-bottom-bar"] header#top .span_3'), i = c,
                r = n.find("nav >ul.buttons"), o = parseInt(t("body.material #header-outer").attr("data-padding")),
                l = parseInt(t("body.material #header-outer").attr("data-logo-height")),
                h = parseInt(n.css("margin-bottom")), u = o + h + l + parseInt(pt.secondaryHeaderHeight);
            ...
            function g() {
                if (!(pt.winW < 1e3 || t("body.page-template-template-no-header").length > 0 || t("body.page-template-template-no-header-footer").length > 0 || t("body.material-ocm-open").length > 0 || "none" == t('#header-outer[data-has-menu="true"][data-format="centered-menu-bottom-bar"] .span_9').css("display") || "none" == t('#header-outer[data-has-menu="true"][data-format="centered-menu-bottom-bar"] .span_9 > nav').css("display"))) if (f = f.length > 0 && pt.secondaryHeaderHeight > 0 ? f.height() : 0, e.hasClass("force-condense") || !e.hasClass("fixed-menu") && pt.scrollTop >= u) {
                    ...
                    if (t('#header-outer[data-megamenu-rt="1"]').length > 0 && t("#header-outer .megamenu").length > 0 && t('#header-outer[data-transparent-header="true"]').length > 0 && d.removeClass("no-transition"), e.addClass("fixed-menu").removeClass("transparent").css({
                        ...
                        r.css("transform", "translateY(" + Math.ceil(parseInt(i) - parseInt(s) - l) + "px)"), r.find(".nectar-woo-cart").css({height: "auto"})
                    }
    ...
    t.fn.dlmenu = function (e) {
        ...
        var a = "";
        return "true" == this.state.open ? (this.state.open = "false", a = "false", this.$toggleBtn.find(".hide").hide(), this.$toggleBtn.find(".show").show(), this.$toggleBtn.find(".top-line, .bottom-line").css({transform: "translateX(0)"}), "left" == this.sidebarPos ? this.$sidebar.css({
            "margin-right": "-25%",
            opacity: "0"
        }) : this.$sidebar.css({
            "margin-left": "-25%",
            opacity: "0"
        }), this.$sidebar.find("> .inner").css({transform: "left" == this.sidebarPos ? "translateX(-100%)" : "translateX(100%)"})) : (this.state.open = "true", a = "true", this.$toggleBtn.find(".show").hide(), this.$toggleBtn.find(".hide").show(), this.$toggleBtn.find(".top-line").css({transform: "translateX(10px)"}), this.$toggleBtn.find(".bottom-line").css({transform: "translateX(-10px)"}), "left" == this.sidebarPos ? this.$sidebar.css({
            "margin-right": "0",
            opacity: "1"
        }) : this.$sidebar.css({
            "margin-left": "0",
            opacity: "1"
        }), this.$sidebar.find("> .inner").css({transform: "translateX(0)"})), setTimeout(function () {
        ...
        a && "" !== a && "NaN" !== a || (a = 0);
        var n = parseFloat(this.$qty.attr("max")), i = parseFloat(this.$qty.attr("min"));
        ...
        if (s.find(".woocommerce-Price-amount, .tax_label").remove(), s.append(n.subtotal), e.nectarOptions && e.nectarOptions.woo_using_cart_addons && "true" === e.nectarOptions.woo_using_cart_addons && n.item_price && n.item_price.length > 0) {
            var r = t(n.item_price), o = i.$qty.closest(".woocommerce-mini-cart-item").find(".product-price");
        ...
        clearTimeout(this.ajaxTimeout), this.ajaxTimeout = setTimeout(function () {
            ...
            var i = {
                ...
                data: {action: "nectar_minicart_update_quantity", quantity: a, item_key: n.state.key},
                cache: !1,
                success: function (t) {
        ...
        var n = this, i = t(a.currentTarget).parents("form.cart");
        if (!(i.closest(".product").hasClass("product-type-external") || wc_add_to_cart_params && "yes" === wc_add_to_cart_params.cart_redirect_after_add) && (a.preventDefault(), 1 != n.state.processing)) {
            ...
            var s = i.closest(".product"), r = i.find("button.single_add_to_cart_button"), o = i.serializeArray(),
                l = 0;
            ...
            }, 50), o.push({name: "action", value: "nectar_ajax_add_to_cart"}, {
                name: "add-to-cart",
                value: n.state.productID
            }), t.ajax({
                type: "POST", url: e.nectarLove.ajaxurl, data: o, cache: !1, success: function (e) {
                    setTimeout(function () {
        ...
        this.$parent.css({"max-height": ""}), !0 === this.state.open && this.$parent.css({"max-height": parseInt(this.$container.outerHeight()) + "px"})
    }, on.prototype.resetHeight = function () {
        this.$parent.css({"max-height": ""}), setTimeout(function () {
        ...
        this.request = t.ajax({
            ...
            cache: !1,
            success: function (e) {
                a.state.requesting = !1, e || a.resetHeight(), e && e.content && e.content !== a.state.prevResults && a.$searchEl.hasClass("material-open") && (a.$container.html(e.content), a.$parent.css({"max-height": parseInt(a.$container.outerHeight()) + "px"}), setTimeout(function () {
                    ...
                    a.$container.find(".product, .search-post-item").css({transition: "box-shadow 0.25s ease, opacity 0.55s cubic-bezier(0.2, 0.6, 0.4, 1), transform 0.55s cubic-bezier(0.2, 0.6, 0.4, 1)"})
    ...
    var un = {timeoutQueued: !1, visible: !0, init: !1, raf: "", bodyOffsetHeight: 1e4};

    function pn() {
        var e = 0, n = 0 == $ && t('#page-header-bg[data-parallax="1"]').length > 0 ? 200 : 60, s = 2,
        ...
        un.bodyOffsetHeight = a.body.offsetHeight, 0 == un.init && setInterval(function () {
            ...
            var o = pt.scrollTop, l = Math.abs(o - e);
            ...
            if (!d.hasClass("side-widget-open") && !t("#header-outer .slide-out-widget-area-toggle a").hasClass("animating")) {
                ...
                }, 400), un.timeoutQueued = !0), d.removeClass("no-transition"), l >= s && (o > e ? (d.hasClass("invisible") || (d.addClass("invisible").removeClass("at-top"), pt.winW > 1e3 && t(".sf-menu").length > 0 && t().superfish && (t(".sf-menu").superfish("hide"), t("header#top nav > ul.sf-menu > li.menu-item-over").removeClass("menu-item-over"))), 1 == r && t(".page-submenu.stuck").css("transform", "translateY(0px)").addClass("header-not-visible")) : (d.hasClass("invisible") && d.removeClass("invisible"), 1 == r && (h = d.outerHeight(), c.length > 0 && (h -= pt.secondaryHeaderHeight), f.length > 0 && pt.winW > 999 ? (i = dt ? f.height() : 0, t(".page-submenu.stuck").css("transform", "translateY(" + (h - i) + "px)").removeClass("header-not-visible")) : t(".page-submenu.stuck").css("transform", "translateY(" + h + "px)").removeClass("header-not-visible")))); else {
    ...
    function fn() {
        var e = pt.scrollTop, a = pt.winW, n = 30;
        1 != $ || pt.usingMobileBrowser || (n = 0), e > n && a >= 1e3 && 0 == t("body.material-ocm-open").length && (r.is(".material") && (0 == t("#search-outer.material-open").length && t('#header-outer[data-transparent-header="true"] .bg-color-stripe').css("transition", "none"), c.length > 0 && (c.addClass("hide-up"), d.css("transform", "translateY(-" + pt.secondaryHeaderHeight + "px)"))), t('#header-outer[data-megamenu-rt="1"]').length > 0 && t('#header-outer[data-transparent-header="true"]').length > 0 && t("#header-outer .megamenu").length > 0 ? "true" == d.attr("data-transparent-header") && 0 == t("#header-outer.side-widget-open").length && 0 == t('#header-outer[data-permanent-transparent="1"]').length && 0 == t(".megamenu.sfHover:not(.width-75):not(.width-50)").length && (d.removeClass("transparent"), d.removeClass("no-transition")) : "true" == d.attr("data-transparent-header") && 0 == t("#header-outer.side-widget-open").length && 0 == t('#header-outer[data-permanent-transparent="1"]').length && d.removeClass("transparent"), t("#header-outer:not(.small-nav) header#top nav > ul > li.menu-item-with-margin").stop(!0, !0).animate({"margin-right": parseInt(t("header#top nav > ul > li.menu-item-with-margin").css("margin-right")) - 3 * parseInt(_) + "px"}, {
            queue: !1,
            duration: 250,
            easing: "easeOutCubic"
        }), t("#header-outer, #search-outer").addClass("small-nav"), t('#header-outer[data-full-width="true"][data-transparent-header="true"]').length > 0 && f.length > 0 && 1 == dt && t('#header-outer[data-full-width="true"] header > .container').stop(!0, !0).animate({padding: "0"}, {
            queue: !1,
            duration: 250,
            easing: "easeOutCubic"
        }), t(".nectar-box-roll").length > 0 && 0 == t('#header-outer[data-permanent-transparent="1"]').length && t("#ajax-content-wrap").animate({"margin-top": Math.floor(w - _ + 2 * y / 1.8 + pt.adminBarHeight + pt.secondaryHeaderHeight)}, {
            queue: !1,
            duration: 250,
            easing: "easeOutCubic"
    ...
    function gn() {
        ...
        1 != $ || pt.usingMobileBrowser || (n = 0), (e <= n && a >= 1e3 || t(".small-nav").length > 0 && t("#ajax-content-wrap.no-scroll").length > 0) && (t("#header-outer, #search-outer").removeClass("small-nav"), t('#header-outer[data-megamenu-rt="1"]').length > 0 && t('#header-outer[data-transparent-header="true"]').length > 0 && t("#header-outer .megamenu").length > 0 ? "true" == d.attr("data-transparent-header") && 0 == t(".nectar-box-roll").length && 0 == t(".megamenu.sfHover:not(.width-75):not(.width-50)").length && (d.addClass("transparent"), d.removeClass("no-transition")) : "true" == d.attr("data-transparent-header") && 0 == t(".nectar-box-roll").length && d.addClass("transparent"), t('#header-outer[data-full-width="true"][data-transparent-header="true"]').length > 0 && f.length > 0 && 1 == dt && t('#header-outer[data-full-width="true"] header > .container').stop(!0, !0).animate({padding: "0 28px"}, {
            queue: !1,
            duration: 250,
            easing: "easeOutCubic"
        }), t("header#top nav > ul > li.menu-item-with-margin").stop(!0, !0).animate({"margin-right": parseInt(t("header#top nav > ul > li.menu-item-with-margin").css("margin-right")) + 3 * parseInt(_) + "px"}, {
            queue: !1,
            duration: 150,
            easing: "easeOutCubic"
        }), c.length > 0 && (c.removeClass("hide-up"), d.removeClass("hide-up").css("transform", "translateY(0%)")), t(".nectar-box-roll").length > 0 && 0 == t('#header-outer[data-permanent-transparent="1"]').length && t("#ajax-content-wrap").animate({"margin-top": Math.floor(w + 2 * y + pt.adminBarHeight + pt.secondaryHeaderHeight)}, {
            queue: !1,
            duration: 250,
            easing: "easeOutCubic"
    ...
    function _n() {
        if (t(".mobile").length > 0) pt.winH < pt.winW && pt.winW > 1e3 ? 0 == t("#header-outer.small-nav").length && t("#header-space").css("height", d.outerHeight()).addClass("calculated") : t("#header-space").css("height", d.outerHeight()).addClass("calculated"); else if (0 == t(".nectar-parallax-scene.first-section").length) {
            var e = y - y / 1.8,
    ...
    function xn() {
        ...
        if (d.is("[data-logo-height]") && d.is("[data-padding]") ? d.hasClass("transparent") || (e = "centered-menu-bottom-bar" == d.attr("data-format") && pt.winW > 1e3 ? d.outerHeight() : d.find("#logo.no-image").length > 0 ? "left-header" == T && pt.winW > 1e3 ? 0 : parseInt(d.find("#logo.no-image").height()) + parseInt(2 * d.attr("data-padding")) : "left-header" == T && pt.winW > 1e3 ? 0 : parseInt(d.attr("data-logo-height")) + parseInt(2 * d.attr("data-padding"))) : e = "left-header" == T && pt.winW > 1e3 ? 0 : d.outerHeight(), g.length > 0 && (a += g.height()), t(".page-header-no-bg").length > 0 && (a += t(".page-header-no-bg").height()), pt.winH - pt.adminBarHeight - e - pt.footerOuterHeight - 1 - a > 0) {
            ...
            t('body[data-footer-reveal="1"]:not(.nectar_using_pfsr) .container-wrap').css({"margin-bottom": pt.footerOuterHeight}), t(".container-wrap").css({"min-height": pt.winH - pt.adminBarHeight - e - pt.footerOuterHeight - a + n})
        } else t('body[data-footer-reveal="1"]:not(.nectar_using_pfsr) .container-wrap').css({"margin-bottom": pt.footerOuterHeight});
        pt.winW < 1e3 ? m.attr("data-midnight", "light") : m.removeAttr("data-midnight")
    }

    function kn() {
        (t('body[data-footer-reveal="1"]').length > 0 || t('body.material[data-slide-out-widget-area-style="slide-out-from-right"]').length > 0) && (setTimeout(xn, 60), xn(), s.on("resize", xn), t('body[data-footer-reveal="1"][data-footer-reveal-shadow="large_2"]').length > 0 && t(".container-wrap").css({boxShadow: "0 70px 110px -30px " + m.css("backgroundColor")}))
    }
    ...
    function On() {
        t(".nectar-recent-posts-slider").each(function () {
            ...
            if (pt.winW > 1e3 && 0 == t("#boxed").length) 0 == t(this).parents(".full-width-content").length ? t('body[data-ext-responsive="true"]').length > 0 && pt.winW >= 1400 ? n.css("height", Math.ceil(e)) : 0 == t('body[data-ext-responsive="true"]').length && pt.winW >= 1100 ? n.css("height", Math.ceil(e)) : n.css("height", Math.ceil(e * a)) : n.css("height", Math.ceil(e * a)); else {
                var i = t(this).parents(".wpb_column").length > 0 ? t(this).parents(".wpb_column") : t(this).parents(".col");
                if (0 == i.length && (i = t(".main-content")), i.hasClass("vc_span12") || i.hasClass("main-content") || i.hasClass("span_12") || i.hasClass("vc_col-sm-12")) e * a <= 250 ? n.css("height", 250) : n.css("height", Math.ceil(e * a)); else {
                    var r = e / function (e) {
                        var a = 1100, n = t(e).attr("class").match(/\d+/);
    ...
    function Mn() {
        (t('.nectar-split-heading[data-animation-type="line-reveal-by-space"]').length > 0 || t('.nectar-split-heading[data-animation-type="letter-fade-reveal"]').length > 0) && (t('.nectar-split-heading[data-animation-type="line-reveal-by-space"]:not([data-text-effect="none"])').each(function () {
            ...
            t(this).find("> *").each(function () {
                ...
                var a = t(this), n = t(this).text().split("");
    ...
    function Wn() {
        ...
        t(".nectar-recent-posts-single_featured.multiple_featured").each(function (e) {
            ...
            var a, n = t(this), i = 0;
            B[e] = {autorotate: ""}, t(this).find(".nectar-recent-post-slide").each(function (e) {
                ...
                if (!t(this).hasClass("active")) {
                    ...
                    var i = t(this).index(), s = t(this).parent().find(".active").index(), r = t(this);
    ...
    function Bn() {
        t(".nectar-recent-posts-slider").each(function () {
            var e = parseInt(t(this).find(".flickity-slider").position().left),
                a = t(this).find(".nectar-recent-post-slide"), n = a.length, i = a.width(),
    ...
    function Ln() {
        t().flickity ? Wn() : setTimeout(function () {
            Wn()
    ...
    function qn() {
        ...
        var n = a, i = (n.getElementsByTagName("body")[0], e), s = n.querySelectorAll(".parallaxImg"), o = s.length,
            l = "ontouchstart" in i || navigator.msMaxTouchPoints, d = !1;
        if (!(o <= 0)) {
            for (var c = 0; c < o; c++) {
                var h = s[c], u = h.querySelectorAll(".parallaxImg-layer"), p = u.length;
                if (!(p <= 0)) {
                    ...
                    var m = n.createElement("div"), v = n.createElement("div"), b = n.createElement("div"),
                        w = n.createElement("div"), y = [];
                    h.id = "parallaxImg__" + c, m.className = "parallaxImg-container", b.className = "parallaxImg-shadow", w.className = "parallaxImg-layers";
                    for (var _ = 0; _ < p; _++) {
                        var C = n.createElement("div"), x = n.createElement("div"), k = u[_].getAttribute("data-img");
                    ...
                    m.appendChild(w), h.appendChild(m), t(h).wrap('<div class="parallaxImg-wrap" />'), -1 != navigator.userAgent.indexOf("Safari") && -1 == navigator.userAgent.indexOf("Chrome") || t(h).parent().append(b), l && t("body.using-mobile-browser").length > 0 || function (a, n, i, s) {
                        t(h).parents(".style-5").on("mousemove", function (r) {
                            var o = t(this), l = o.find(".parallaxImg-container"), d = o.find(".parallaxImg-shadow"),
                                c = Date.now(), h = t(a).parents(".wpb_gallery").length > 0;
        ...
        function $(e, a, n, i, s, r, o, l, d, c) {
            ...
            var h = .03, u = .063, p = "1.03", f = "-10", g = !1;
            ...
            var m, v = pt.scrollTop, b = a ? e.touches[0].pageX : e.pageX, w = a ? e.touches[0].pageY : e.pageY,
                y = n.getBoundingClientRect(), _ = n.clientWidth || n.offsetWidth || n.scrollWidth,
                C = n.clientHeight || n.offsetHeight || n.scrollHeight, x = 320 / _, k = .52 - (b - y.left - 0) / _,
                $ = .52 - (w - y.top - v) / C, T = w - y.top - v - C / 2, E = h * x * (k - (b - y.left - 0 - _ / 2)),
                O = u * x * (T - $);
        ...
        function I(e, a) {
            var n = a.clientWidth || a.offsetWidth || a.scrollWidth, i = a.firstChild;
    ...
    function Yn() {
        if (P = [], r.on("mouseenter", '.nectar_video_lightbox[data-parent-hover="1"]', function () {
            ...
            e.find("> .row-bg-wrap .row-bg, > .nectar-video-wrap .nectar-video-inner").addClass("transition"), e.find("> .row-bg-wrap .row-bg, > .nectar-video-wrap .nectar-video-inner").css({transform: "scale(1.08)"})
        }), r.on("mouseleave", '.nectar_video_lightbox[data-parent-hover="1"]', function () {
            t(this).parents(".wpb_row").find("> .row-bg-wrap .row-bg, > .nectar-video-wrap .nectar-video-inner").css({transform: "scale(1)"})
        ...
        t(".nectar-video-box").each(function (e) {
            if (t(this).find(".play_button_mouse_follow").length > 0) {
                ...
                t(this).imagesLoaded(function () {
                    ...
                    a.is('[data-mouse-style="solid_color"]') && a.find(".play_button_mouse_follow").css({"background-color": t}), a.find(".play_button_mouse_follow").addClass("visible")
                })
            }
        })
    }
    ...
    function Rn(e) {
        if (!(t("body.vc_editor").length > 0)) {
            var a = e.find(".project-slides").length > 0 ? ".dot-nav > span" : ".controls > li",
                n = e.find(".project-slides").length > 0 ? "span" : " li", i = e.find(a).length;
    ...
    function Xn() {
        t(".infinite_scroll").length > 0 && (t(".portfolio-items.infinite_scroll").infinitescroll({
            ...
            t(e).css("opacity", 0).imagesLoaded(function () {
                var n;
                (t(e).css("opacity", 1), a.isotope("appended", t(e)), t(e).find(".work-item").addClass("ajax-loaded"), t(e).addClass("ajax-loaded"), t(e).find(".work-meta, .nectar-love-wrap").css({opacity: 1}), t(".portfolio-filters-inline").length > 0 || t(".portfolio-filters").length > 0) && (n = t(".portfolio-filters-inline").length > 0 ? t(".portfolio-filters-inline a.active").attr("data-filter") : t(".portfolio-filters a.active").attr("data-filter"), t(".portfolio-filters-inline a.active").attr("data-filter"), a.isotope({filter: n}));
                for (var i = 0; i < M.length; i++) M[i].reLayout();
                if (t(e).find(".work-item.style-5").length > 0 && qn(), "none" == t(e).find(".inner-wrap").attr("data-animation")) t(".portfolio-items .col .inner-wrap").removeClass("animated"); else {
                    for (i = 0; i < M.length; i++) M[i].masonryZindex(), M[i].portfolioAccentColor();
                    t(e).each(function () {
                        var e = t("#nectar_fullscreen_rows").length > 0 ? "200%" : "90%", a = t(this),
                            n = new Waypoint({
                                element: a[0], handler: function () {
            ...
            var n = t(e);
            if (0 == n.find("img").length) n = t("body"); else if (jt()) {
            ...
            n.imagesLoaded(function () {
                ...
                })), "none" == t(e).parents(".posts-container").attr("data-animation")) t(e).find(".inner-wrap").removeClass("animated"); else {
    ...
    function Nn() {
        pt.scrollTop > 350 && !o.is(".fullscreen.open") && (t("#to-top").stop().transition({transform: "translateY(-50%)"}, 350, "easeInOutCubic"), s.off("scroll", Nn), s.on("scroll", Dn))
    }

    function Dn() {
        if (pt.scrollTop < 350 || o.is(".fullscreen.open")) {
            var e = t("#slide-out-widget-area.fullscreen.open").length > 0 ? 1150 : 350;
            t("#to-top").stop().transition({transform: "translateY(105%)"}, e, "easeInOutQuint"), s.off("scroll", Dn), s.on("scroll", Nn)
        }
    }
    ...
    function Qn() {
        ...
        r.on("click", '#to-top, a[href="#top"]', function () {
            return t("body,html").stop().animate({scrollTop: 0}, 800, "easeOutQuad", function () {
    ...
    function Zn() {
        ...
        1 == n && i.push("#header-outer nav"), t('.page-submenu[data-sticky="true"] a[href*="#"]').length > 0 && i.push('.page-submenu[data-sticky="true"]'), i.length > 0 && i.forEach(function (n, i) {
            (0 == i ? r : t(e)).scrollspy({target: n, offset: a + pt.adminBarHeight + 40})
        })
    }
    ...
    function Gn() {
        ...
        var n = a && a.length > 0 ? a.substring(1, a.length) : 0, i = y - y / 1.8, o = 0;
        if (n && (o = (o = n.split("/")).length), n && o > 1 && (n = n.replace(/\//g, ""), a = a.replace(/\//g, "")), a && t(".main-content").find(a).length > 0 || a && t(".main-content").find('[data-fullscreen-anchor-id="' + n + '"]').length > 0) {
            ...
            t(".nectar-box-roll").length > 0 && t(".container-wrap.bottomBoxOut").length > 0 && (ht.boxRoll(null, -1), u = 2050), t("img[data-nectar-img-src]").length > 0 && (ea(), u = 200), setTimeout(function () {
                ...
                } else if (0 == t('body[data-permanent-transparent="1"]').length) if (r.hasClass("mobile")) e = t('#header-outer[data-mobile-fixed="1"]').length > 0 ? l.offset().top + 2 - h + pt.adminBarHeight : l.offset().top - pt.adminBarHeight + 1; else {
    ...
    function Un() {
        ...
        t(".portfolio-items:not(.carousel)").each(function (a) {
            if (t(this).attr("instance", a), t(this).parent().parent().find("div[class^=portfolio-filters]").attr("instance", a), "undefined" != typeof SalientPortfolio) M[e] = new SalientPortfolio(t(this), Le, ot, Ie), e++; else {
                var n = t(this);
    ...
    function ti(e) {
        "none" == e.attr("data-load-animation") ? e.find(".inner-wrap").removeClass("animated") : e.find("article").each(function (e) {
            ...
            }); else var a = t(this), n = new Waypoint({
                element: a[0], handler: function () {
                    setTimeout(function () {
                        a.addClass("animated-in")
    ...
    function hi() {
        t(".wpb_row").removeClass("only-ns"), t('.nectar-slider-wrap[data-full-width="true"], .page-submenu, .portfolio-items[data-col-num="elastic"]:not(.fullwidth-constrained), .blog-fullwidth-wrap').parents(".wpb_row").addClass("only-ns"), t("body.vc_editor.compose-mode .wpb_row .vc_vc_column > .wpb_column > .vc_column-inner").each(function () {
            if (t(this).find("> .vc_element-container > div").length > 0) {
                var e = t(this).find("> .vc_element-container"), a = e.find("> div:first-child");
    ...
    function ui() {
        t('.vc_element > .wpb_column[class*="padding-"][class*="-percent"]').each(function () {
            var e = 4, a = this.className.match(/padding-\d+/);
    ...
    function pi() {
        setTimeout(function () {
            ...
            if (hi(), _e(), be(), It(), Be(), wt(), fe(), je(), ke(), jn(), ya(), qt(), oa(), Mn(), Yn(), Pe(), ia(), t(".carousel").length > 0 && (Ht(), Ft(), Bt()), t(".owl-carousel").length > 0 && (t(".owl-carousel").each(function () {
                ...
                Re()
            }), Ie(), Fe(), Ln(), t(".wpb_row.nectar-split-heading-merged").length > 0 && t(".wpb_row.nectar-split-heading-merged").removeClass("nectar-split-heading-merged"), F.length > 0) for (var a = 0; a < F.length; a++) F[a].instance.reloadCells(), F[a].instance.off("scroll.flickity"), F[a].instance.off("dragStart.flickity"), F[a].instance.off("dragEnd.flickity");
            if (Ct(), setTimeout(function () {
                if (xt(), F.length > 0) for (var t = 0; t < F.length; t++) F[t].instance.reloadCells(), F[t].instance.resize()
            }, 100), Q.length > 0) for (a = 0; a < Q.length; a++) Q[a].instance.flickity("reloadCells"), Q[a].instance.off("scroll.flickity"), Q[a].instance.off("dragStart.flickity"), Q[a].instance.off("dragEnd.flickity");
            setTimeout(function () {
                if (t(".nectar-woo-flickity").length > 0 && Wt(), Q.length > 0) for (var e = 0; e < Q.length; e++) Q[e].instance.flickity("reloadCells"), Q[e].instance.flickity("resize")
            }, 100), fa();
            ...
            if (ga(), pa(), wa(), se(), Ke(), we(), Ua(), _a(), Ca(), Le(), setTimeout(Le, 1e3), $a(), Tn(), s.off("scroll.parallaxSections").off("resize.parallaxSections"), We(), Ae(), ei(), Un(), M.length > 0) for (a = 0; a < M.length; a++) M[a].portfolioAccentColor();
            if (qn(), Vn(), setTimeout(function () {
                if (t(".nectar_fullscreen_zoom_recent_projects").length > 0 && D.length > 0) for (var e = 0; e < D.length; e++) D[e].sliderCalcs()
                ...
                }), n > -1 && t.fn.fullpage.silentMoveTo(n + 1, 0), 1 === t("#nectar_fullscreen_rows > div.vc_element").length && t("#nectar_fullscreen_rows").css({transform: "translate3d(0,0,0)"}), r.scrollTo(0, 0)
                ...
                "padding-top": "0",
                "margin-top": "0"
            }) : t(".container-wrap").css({"padding-top": "40px"});
    ...
    function fi() {
        ...
        if (t('body[data-ajax-transitions="true"]').length > 0 && t('#ajax-loading-screen[data-disable-mobile="1"]').length > 0 && pt.winW < 1e3 && (a = !0), t('body[data-ajax-transitions="true"]').length > 0 && t('#ajax-loading-screen[data-method="standard"]').length > 0 && 0 == a) {
            if (t("html").addClass("page-trans-loaded"), t('#ajax-loading-screen[data-effect="standard"]').length > 0 ? (0 == t(".nectar-particles").length && (p.transition({opacity: 0}, 500, function () {
                t(this).css({display: "none"})
            }), t("#ajax-loading-screen .loading-icon").transition({opacity: 0}, 500)), 0 == t(".nectar-box-roll").length && setTimeout(function () {
                Ka()
                ...
                e.persisted && (t("#ajax-loading-screen").stop().transition({opacity: 0}, 200, function () {
                    t(this).css({display: "none"})
                }), t("#ajax-loading-screen .loading-icon").transition({opacity: 0}, 100))
                ...
                t('a[href^="mailto"], a[href^="tel"], .woocommerce-order-downloads a[class*="downloads-file"], .wpdm-cta.download-link a[data-downloadurl], .nectar-ignore-beforeunload a').on("click", function () {
                    ...
                    n || (p.addClass("set-to-fade"), t('#ajax-loading-screen[data-effect*="horizontal_swipe"]').length > 0 ? (p.removeClass("loaded"), p.addClass("in-from-right"), setTimeout(function () {
                        p.addClass("loaded")
                    }, 30)) : t('#ajax-loading-screen[data-effect="center_mask_reveal"]').length > 0 ? p.css("opacity", "0").css("display", "block").transition({opacity: "1"}, 450) : p.show().transition({opacity: "1"}, 450)), n = !1
                })
            }
        } else 1 == a && p.css({
            opacity: "0",
    ...
    function gi(n) {
        var i, l, u, p, g;
        pt.usingMobileBrowser && pt.scrollPosRAF(), sa(), function () {
            var n;
            if (zt(), 0 != t('body[data-header-format="left-header"]').length || pt.usingPhoneBrowser || (n = !(t('#header-outer[data-megamenu-rt="1"]').length > 0 && t('#header-outer[data-transparent-header="true"]').length > 0), e.nectarOptions && e.nectarOptions.dropdown_hover_intent && "add" === e.nectarOptions.dropdown_hover_intent && (n = !1), t(".sf-menu:not(.buttons)").superfish({
                ...
                var a = t("#top .container").width(), n = t(this).children("ul");
                ...
                var e = t(this).parents(".nectar-megamenu-menu-item"), a = t(this).attr("data-bg-src"),
                    n = t(this).attr("data-align").replace("_", " ");
                e.find("> ul").css({"background-position": n, "background-image": 'url("' + a + '")'}), t(this).remove()
            }), t(".sf-menu > .nectar-megamenu-menu-item > ul > li > a .menu-title-text .megamenu-col-bg-lazy[data-bg-src]").each(function () {
                var e = t(this).closest(".menu-item"), a = t(this).attr("data-bg-src"),
                    n = t(this).attr("data-align").replace("_", " ");
                e.css({"background-position": n, "background-image": 'url("' + a + '")'}), t(this).remove()
            ...
            t(".sub-menu .nectar-menu-icon, .sub-menu .nectar-menu-icon-img, .off-canvas-menu-container > ul > li > a .nectar-menu-icon, .off-canvas-menu-container > ul > li > a .nectar-menu-icon-img").each(function () {
                var e = t(this).parent(), a = t(this).detach();
            ...
            function i() {
                if (r.hasClass("ascend") || t('body[data-header-format="left-header"]').length > 0 && 0 == t("body.material").length ? (t("#search-outer").stop().transition({opacity: 0}, 300, "cubic-bezier(0.2, 1, 0.3, 1)"), h.addClass("inactive"), setTimeout(function () {
            ...
            r.hasClass("material") && 0 == t("#header-outer .bg-color-stripe").length && d.append('<div class="bg-color-stripe" />'), r.on("click", "#search-btn a", function () {
                ...
                return !t(this).hasClass("open-search") && (r.hasClass("original") && t(".slide-out-widget-area-toggle.mobile-icon a.open").length > 0 && (t(".slide-out-widget-area-toggle.mobile-icon a").addClass("non-human-allowed").trigger("click"), setTimeout(function () {
                    ...
                    scale: "1,0",
                    opacity: 1
                }, 0).transition({scale: "1,1"}, 700, "cubic-bezier(0.2, 1, 0.3, 1)"), t("#search-outer > #search form").delay(350).transition({
                    opacity: 1,
                    transform: "translateY(0)"
                }, 700, "cubic-bezier(0.2, 1, 0.3, 1)"), t("#search-outer #search #close").delay(500).transition({opacity: 1}, 700, "cubic-bezier(0.2, 1, 0.3, 1)"), t("#search-outer #search .span_12 span").delay(450).transition({
                    opacity: 1,
                    transform: "translateY(0)"
        ...
        }), Ya(), Ia(), "separate-dropdown-parent-link" == (t("#slide-out-widget-area[data-dropdown-func]").length > 0 ? o.attr("data-dropdown-func") : "default") && t("#slide-out-widget-area .off-canvas-menu-container li.menu-item-has-children").append('<span class="ocm-dropdown-arrow"><i class="fa fa-angle-down"></i></span>'), function () {
            if (!(!t('#header-outer[data-format="left-header"]').length > 0 && !t('body.material[data-slide-out-widget-area-style*="slide-out-from-right"]').length > 0 && !t("#slide-out-widget-area.fullscreen-split").length > 0 && !t('#slide-out-widget-area[data-dropdown-func="separate-dropdown-parent-link"]').length > 0)) {
                ...
                "separate-dropdown-parent-link" === i && (n = '#header-outer[data-format="left-header"] nav li.menu-item-has-children > a .sf-sub-indicator'), t(n + ", " + a).on("click", function () {
                    var e = t(this).parent();
                    if ("separate-dropdown-parent-link" === i && (e = t(this).closest(".menu-item")), e.hasClass("open-submenu")) e.find(".sub-menu").css({"max-height": "0"}), e.removeClass("open-submenu"); else {
                        var a, n = t(this);
                        e.find("> .sub-menu").addClass("no-trans"), setTimeout(function () {
                            ...
                            n.closest("ul").find("li.menu-item-has-children").removeClass("open-submenu"), n.closest("ul").find("li.menu-item-has-children > .sub-menu").css({"max-height": "0"}), e.addClass("open-submenu"), e.find("> .sub-menu").css("max-height", a), n.parents("ul").length > 0 && n.parents("ul:not(.sf-menu)").each(function () {
            ...
            var e = t(this).parents("#page-header-bg"), a = e.height(),
                ...
                o = t('body[data-header-format="left-header"]').length > 0 ? 0 : t("#header-space").height(), l = 0;
            if (t("body.material").length > 0 && c.length > 0 && (l = c.height()), 0 == t('body[data-permanent-transparent="1"]').length) if (r.hasClass("mobile")) Gt((t('#header-outer[data-mobile-fixed="1"]').length > 0 ? parseInt(a) - o + parseInt(e.offset().top) + 2 : parseInt(a) + parseInt(e.offset().top) + 2) - 2 * i, 700, "easeInOutQuint"); else if (t('body[data-hhun="1"]').length > 0 && 0 == t('#header-outer[data-remove-fixed="1"]').length) Gt(parseInt(a) + n + 2 - 2 * i, 700, "easeInOutQuint"); else {
                ...
                setTimeout(Zn, 100), r.on("click", "#header-outer nav .sf-menu a, #header-outer .mobile-header .sf-menu a, #footer-outer .nectar-button, #footer-outer .widget_nav_menu a, #footer-widgets .textwidget a, #mobile-menu li a, .nectar-scrolling-tabs:not(.navigation_func_active_link_only) .scrolling-tab-nav a, .container-wrap a:not(.wpb_tabs_nav a):not(.navigation_func_active_link_only .scrolling-tab-nav a):not(.comment-wrap .navigation a):not(.woocommerce-checkout a):not(.um-woo-view-order):not(.magnific):not([data-fancybox]):not(.woocommerce-tabs .tabs a):not(.slider-prev):not(.slider-next):not(.testimonial-next-prev a):not(.page-numbers), .swiper-slide .button a, #slide-out-widget-area a, #slide-out-widget-area .inner div a", function (i) {
                    ...
                    if ((t(".page-template-template-no-header-footer").length > 0 || t(".page-template-template-no-header").length > 0 || 0 == t("#header-space").length) && (h = 0), 0 != ut.$usingFullScreenRows && t('#nectar_fullscreen_rows[data-anchors="on"]').length > 0 && l && "" != l && "#top" != l && t('body.material[data-slide-out-widget-area-style="slide-out-from-right"].material-ocm-open').length > 0 && (i.preventDefault(), t(this).hasClass("skip-hash") || (history.pushState ? history.pushState(null, null, l) : location.hash = l), setTimeout(function () {
                        ...
                        t(".nectar-box-roll").length > 0 && t(".container-wrap.bottomBoxOut").length > 0 && (ht.boxRoll(null, -1), p = 2050), t("img[data-nectar-img-src]").length > 0 && (ea(), p = 200), setTimeout(function () {
                            ...
                            } else if (0 == t('body[data-permanent-transparent="1"]').length) if (r.hasClass("mobile")) e = t('#header-outer[data-mobile-fixed="1"]').length > 0 ? t(l).offset().top + 2 - h + pt.adminBarHeight : t(l).offset().top - pt.adminBarHeight + 1; else {
                            ...
                            var p,
                                g = f.parents('.page-submenu[data-sticky="true"]').length > 0 ? f.parents(".page-submenu").height() : 0;
