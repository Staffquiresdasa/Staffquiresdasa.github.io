...
!function (e) {
    ...
    var e, n, i, d, r, o, p, h, f, g, m, y, s, a, v,
        i = (t && t.fn && t.fn.select2 && t.fn.select2.amd && (u = t.fn.select2.amd), u && u.requirejs || (u ? n = u : u = {}, f = {}, g = {}, m = {}, y = {}, s = Object.prototype.hasOwnProperty, a = [].slice, v = /\.js$/, p = function (e, t) {
            var n, i, s = c(e), r = s[0];
            return e = s[1], r && (n = b(r = l(r, t))), r ? e = n && n.normalize ? n.normalize(e, (i = t, function (e) {
                return l(e, i)
            })) : l(e, t) : (r = (s = c(e = l(e, t)))[0], e = s[1], r && (n = b(r))), {
                f: r ? r + "!" + e : e,
                n: e,
                pr: r,
                p: n
            ...
            require: function (e) {
                ...
                return {
                    id: e, uri: "", exports: f[e], config: (t = e, function () {
            ...
            if (i = i || e, "undefined" == u || "function" == u) {
                for (t = !t.length && n.length ? ["require", "exports", "module"] : t, a = 0; a < t.length; a += 1) if ("require" === (r = (o = p(t[a], i)).f)) c[a] = h.require(e); else if ("exports" === r) c[a] = h.exports(e), l = !0; else if ("module" === r) s = c[a] = h.module(e); else if (_(f, r) || _(g, r) || _(y, r)) c[a] = b(r); else {
                ...
                u = n ? n.apply(f[e], c) : undefined, e && (s && s.exports !== d && s.exports !== f[e] ? f[e] = s.exports : u === d && l || (f[e] = u))
            } else e && (f[e] = n)
            ...
            return t = t || function () {
            }, "function" == typeof n && (n = i, i = s), i ? r(d, e, t, n) : setTimeout(function () {
                r(d, e, t, n)
            }, 4), o
        }, o.config = function (e) {
            return o(e)
        ...
        }).amd = {jQuery: !0}, u.requirejs = e, u.require = n, u.define = i), u.define("almond", function () {
            ...
            return e.Extend(i, e.Observable), i.prototype.render = function () {
                ...
                this.data.current(function (e) {
                    ...
                    t.$results.find(".select2-results__option[aria-selected]").each(function () {
                        var e = d(this), t = d.data(this, "data"), n = "" + t.id;
                ...
                if (e.children) {
                    var r = d(t), o = document.createElement("strong");
                    o.className = "select2-results__group";
                    d(o);
                    this.template(e, o);
                    for (var a = [], l = 0; l < e.children.length; l++) {
                        var c = e.children[l], c = this.option(c);
                        a.push(c)
                    }
                ...
                this.$results.attr("id", n), t.on("results:all", function (e) {
                    ...
                    0 !== t.length && (e = t.data("data"), "true" == t.attr("aria-selected") ? s.trigger("close", {}) : s.trigger("select", {data: e}))
                    ...
                    var t = s.$results.scrollTop(), n = s.$results.get(0).scrollHeight - t + e.deltaY,
                        t = 0 < e.deltaY && t - e.deltaY <= 0, n = e.deltaY < 0 && n <= s.$results.height();
            ...
            return t.prototype.render = function (e) {
                ...
                e.call(this, t, n), t.on("open", function () {
                    ...
                    var t;
                    e.stopPropagation(), i.trigger("keypress", e), i._keyUpPrevented = e.isDefaultPrevented(), e.which !== r.BACKSPACE || "" !== i.$search.val() || 0 < (t = i.$searchContainer.prev(".select2-selection__choice")).length && (t = t.data("data"), i.searchRemoveChoice(t), e.preventDefault())
                });
            ...
            return e.prototype.bind = function (e, t, n) {
                ...
                e.call(this, t, n), t.on("*", function (e, t) {
                    var n;
                    -1 !== o.inArray(e, s) && (t = t || {}, n = o.Event("select2:" + e, {params: t}), i.$element.trigger(n), -1 !== o.inArray(e, r) && (t.prevented = n.isDefaultPrevented()))
                })
            }, e
            ...
            return t.Extend(n, e), n.prototype.current = function (e) {
                ...
                var e, r = this;
                if (s.selected = !0, o(s.element).is("option")) return s.element.selected = !0, void this.$element.trigger("change");
                ...
                if (this.$element.prop("multiple")) {
                    if (s.selected = !1, o(s.element).is("option")) return s.element.selected = !1, void this.$element.trigger("change");
                ...
                o.isPlainObject(e) || (e = {id: e, text: e});
                return null != (e = o.extend({}, {text: ""}, e)).id && (e.id = e.id.toString()), null != e.text && (e.text = e.text.toString()), null == e._resultId && e.id && null != this.container && (e._resultId = this.generateResultId(this.container, e)), o.extend({}, {
                    selected: !1,
                    disabled: !1
                }, e)
            ...
            return c.Extend(i, e), i.prototype.select = function (n) {
                ...
                for (var r = 0; r < e.length; r++) {
                    ...
                    }(l)), a = this.item(o), a = u.extend(!0, {}, l, a), a = this.option(a), o.replaceWith(a)) : (a = this.option(l), l.children && (l = this.convertToOptions(l.children), c.appendMany(a, l)), s.push(a))
                }
                return s
            }, i
            ...
            return t.Extend(n, e), n.prototype._applyDefaults = function (e) {
                ...
                var s = r.extend({type: "GET"}, this.ajaxOptions);

                function e() {
                    var e = s.transport(s, function (e) {
                        e = i.processResults(e, t);
                        i.options.get("debug") && window.console && console.error && (e && e.results && r.isArray(e.results) || console.error("Select2: The AJAX results did not return an array in the `results` key of the response.")), n(e)
                    }, function () {
            ...
            function e(e, t, n) {
                ...
                s = n.get("insertTag");
                if (s !== undefined && (this.insertTag = s), e.call(this, t, n), a.isArray(i)) for (var r = 0; r < i.length; r++) {
            ...
            return e.prototype.query = function (e, l, c) {
                ...
                this._removeOldTags(), null != l.term && null == l.page ? e.call(this, l, function d(e, t) {
                    for (var n = e.results, i = 0; i < n.length; i++) {
                        var s = n[i], r = null != s.children && !d({results: s.children}, !0);
                        if (s.text === l.term || r) return !t && (e.data = n, void c(e))
                    }
                    if (t) return !0;
                    var o, a = u.createTag(l);
                    null != a && ((o = u.option(a)).attr("data-select2-tag", !0), u.addOptions([o]), u.insertTag(n, a)), e.results = n, c(e)
                }) : e.call(this, l, c)
            ...
            return e.prototype.bind = function (e, t, n) {
                ...
                var s = this.tokenizer(t, this.options, function (e) {
                    ...
                    }).length || ((t = i.option(n)).attr("data-select2-tag", !0), i._removeOldTags(), i.addOptions([t])), t = n, i.trigger("select", {data: t})
                });
                ...
                for (var s = n.get("tokenSeparators") || [], r = t.term, o = 0, a = this.createTag || function (e) {
                    ...
                    var l = r[o];
                    -1 !== c.inArray(l, s) ? (l = r.substr(0, o), null != (l = a(c.extend({}, t, {term: l}))) ? (i(l), r = r.substr(o + 1) || "", o = 0) : o++) : o++
                }
                return {term: r}
            }, e
            ...
            return e.prototype.bind = function (e, t, n) {
                ...
                var t = c("<span></span>"), e = e.call(this);
                return t.append(e), this.$dropdownContainer = t
            }, e.prototype._hideDropdown = function (e) {
                this.$dropdownContainer.detach()
            }, e.prototype._attachPositioningHandler = function (e, t) {
                var n = this, i = "scroll.select2." + t.id, s = "resize.select2." + t.id,
                ...
                this.$container.parents().filter(o.hasScroll).off(n), c(window).off(n + " " + i + " " + t)
            }, e.prototype._positionDropdown = function () {
                var e = c(window), t = this.$dropdown.hasClass("select2-dropdown--above"),
            ...
            return n.prototype.apply = function (e) {
                ...
                if (null == (e = p.extend(!0, {}, this.defaults, e)).dataAdapter && (null != e.ajax ? e.dataAdapter = E : null != e.data ? e.dataAdapter = x : e.dataAdapter = A, 0 < e.minimumInputLength && (e.dataAdapter = w.Decorate(e.dataAdapter, S)), 0 < e.maximumInputLength && (e.dataAdapter = w.Decorate(e.dataAdapter, T)), 0 < e.maximumSelectionLength && (e.dataAdapter = w.Decorate(e.dataAdapter, D)), e.tags && (e.dataAdapter = w.Decorate(e.dataAdapter, C)), null == e.tokenSeparators && null == e.tokenizer || (e.dataAdapter = w.Decorate(e.dataAdapter, O)), null != e.query && (t = h(e.amdBase + "compat/query"), e.dataAdapter = w.Decorate(e.dataAdapter, t)), null != e.initSelection && (t = h(e.amdBase + "compat/initSelection"), e.dataAdapter = w.Decorate(e.dataAdapter, t))), null == e.resultsAdapter && (e.resultsAdapter = f, null != e.ajax && (e.resultsAdapter = w.Decorate(e.resultsAdapter, P)), null != e.placeholder && (e.resultsAdapter = w.Decorate(e.resultsAdapter, j)), e.selectOnClose && (e.resultsAdapter = w.Decorate(e.resultsAdapter, R))), null == e.dropdownAdapter && (e.multiple ? e.dropdownAdapter = q : (n = w.Decorate(q, L), e.dropdownAdapter = n), 0 !== e.minimumResultsForSearch && (e.dropdownAdapter = w.Decorate(e.dropdownAdapter, I)), e.closeOnSelect && (e.dropdownAdapter = w.Decorate(e.dropdownAdapter, M)), null == e.dropdownCssClass && null == e.dropdownCss && null == e.adaptDropdownCssClass || (n = h(e.amdBase + "compat/dropdownCss"), e.dropdownAdapter = w.Decorate(e.dropdownAdapter, n)), e.dropdownAdapter = w.Decorate(e.dropdownAdapter, k)), null == e.selectionAdapter && (e.multiple ? e.selectionAdapter = m : e.selectionAdapter = g, null != e.placeholder && (e.selectionAdapter = w.Decorate(e.selectionAdapter, y)), e.allowClear && (e.selectionAdapter = w.Decorate(e.selectionAdapter, v)), e.multiple && (e.selectionAdapter = w.Decorate(e.selectionAdapter, _)), null == e.containerCssClass && null == e.containerCss && null == e.adaptContainerCssClass || (l = h(e.amdBase + "compat/containerCss"), e.selectionAdapter = w.Decorate(e.selectionAdapter, l)), e.selectionAdapter = w.Decorate(e.selectionAdapter, $)), "string" == typeof e.language && (0 < e.language.indexOf("-") ? (c = e.language.split("-")[0], e.language = [e.language, c]) : e.language = [e.language]), p.isArray(e.language)) {
                    ...
                    var l = b.loadPath(this.defaults.amdLanguageBase + "en"), c = new b(e.language);
                ...
                this.defaults = {
                    ...
                    matcher: function a(e, t) {
                        ...
                        var s = o(t.text).toUpperCase(), r = o(e.term).toUpperCase();
            ...
            function e(e, t) {
                this.options = e, null != t && this.fromElement(t), this.options = i.apply(this.options), t && t.is("input") && (t = n(this.get("amdBase") + "compat/inputData"), this.options.dataAdapter = o.Decorate(this.options.dataAdapter, t))
            }
            ...
            var o = function (e, t) {
                null != e.data("select2") && e.data("select2").destroy(), this.$element = e, this.id = this._generateId(e), t = t || {}, this.options = new r(t, e), o.__super__.constructor.call(this);
            ...
            return n.Extend(o, n.Observable), o.prototype._generateId = function (e) {
                ...
                if (t === undefined && (t = {}), e in i) {
                    var s = i[e], i = {prevented: !1, name: e, args: t};
    ...
    function l(e, t) {
        ...
        if (e && "." === e.charAt(0)) if (t) {
            for (t = (e = e.split("/")).length - 1, m.nodeIdCompat && v.test(e[t]) && (e[t] = e[t].replace(v, "")), e = p.slice(0, p.length - 1).concat(e), c = 0; c < e.length; c += 1) if ("." === (d = e[c])) e.splice(c, 1), --c; else if (".." === d) {
        ...
        if ((p || f) && h) {
            for (c = (n = e.split("/")).length; 0 < c; --c) {
                if (i = n.slice(0, c).join("/"), p) for (u = p.length; 0 < u; --u) if (s = (s = h[p.slice(0, u).join("/")]) && s[i]) {
                    r = s, o = c;
                    break
                }
                if (r) break;
    ...
    function b(e) {
        var t;
        if (_(g, e) && (t = g[e], delete g[e], y[e] = !0, r.apply(d, t)), !_(f, e) && !_(y, e)) throw new Error("No " + e);
        return f[e]
    }
