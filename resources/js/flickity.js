!function (t, e) {
    ...
    "use strict";
    var i = Array.prototype.slice, n = t.console, s = void 0 === n ? function () {
    } : function (t) {
        n.error(t)
    };
    ...
    function a(e) {
        if (function () {
            ...
            for (var c = h.isBorderBox = "border-box" == l.boxSizing, d = 0; d < n; d++) {
                var u = i[d], f = l[u], p = parseFloat(f);
                h[u] = isNaN(p) ? 0 : p
            }
            var g = h.paddingLeft + h.paddingRight, v = h.paddingTop + h.paddingBottom,
                m = h.marginLeft + h.marginRight, y = h.marginTop + h.marginBottom,
    ...
    i.makeArray = function (t) {
        ...
        return t.forEach(function (t) {
            if (t instanceof HTMLElement || 0 != jQuery("body.compose-mode").length) if (n) {
                e(t, n) && s.push(t);
    ...
    return p.setCellAlign = function () {
        ...
        var i = n.modulo(t, e), s = Math.abs(i - this.selectedIndex), o = Math.abs(i + e - this.selectedIndex),
        ...
        var e = t.pageYOffset;
        this.element.focus({preventScroll: !0}), t.pageYOffset != e && e > 10 && t.scrollTo(t.pageXOffset, e)
    ...
    return s.pointerDownFocus = function (t) {
        ...
        var e = "touchstart" == t.type, i = "touch" == t.pointerType, n = o[t.target.nodeName];
    ...
    "function" == typeof define && define.amd ? define("flickity-as-nav-for/as-nav-for", ["flickity/js/index", "fizzy-ui-utils/utils"], e) : "object" == typeof module && module.exports ? module.exports = e(require("resources/js/flickity"), require("fizzy-ui-utils")) : t.Flickity = e(t.Flickity, t.fizzyUIUtils)
}(window, function (t, e) {
    ...
    return i._createAsNavFor = function () {
        ...
        if (e) {
            var i, n, s, o = e[0], r = this.navCompanion.cells.indexOf(o), a = r + e.length - 1,
    ...
    "function" == typeof define && define.amd ? define(["flickity/js/index", "imagesloaded/imagesloaded"], function (i, n) {
        return e(t, i, n)
    }) : "object" == typeof module && module.exports ? module.exports = e(t, require("resources/js/flickity"), require("imagesloaded")) : t.Flickity = e(t, t.Flickity, t.imagesLoaded)
}(window, function (t, e, i) {
    "use strict";
