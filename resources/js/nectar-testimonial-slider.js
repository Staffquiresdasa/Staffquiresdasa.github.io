!function (t) {
    ...
    i.prototype.createTestimonialControls = function () {
        ...
        if ("multiple_visible" != this.type && "multiple_visible_minimal" != this.type) if (this.el.animate({opacity: "1"}, 800), this.el.find("blockquote").length > 1) {
            ...
            if (this.el.is('[data-style="minimal"]')) {
                ...
                }).css("z-index", "20"), this.el.hasClass("disable-height-animation") || this.el.find(".slides").css({height: this.el.find(".slides " + l + ":first-child").height() + 40 + "px"})), this.el.attr("data-autorotate").length > 0) {
            ...
            this.el.find(".slides blockquote").css({
                ...
                opacity: "1",
                transform: "translateX(0px)"
            }).css("z-index", "20"), this.el.find(".slides").stop(!0, !0).animate({height: r + 20 + "px"}, 450, "easeOutCubic")
        }
        ...
        var l = "multiple_visible_minimal" == this.el.attr("data-style"), n = !(t("body.vc_editor").length > 0),
            a = t("body.vc_editor").length > 0, o = !0, r = !1;
        ...
        var s = t("body.vc_editor").length > 0 ? "> div" : "blockquote", l = e.index(),
        ...
        e.parents(".testimonial_slider").find("li span").removeClass("active"), e.find("span").addClass("active"), e.parents(".testimonial_slider").find(".slides " + s).addClass("no-trans"), e.parents(".testimonial_slider").find(".slides " + s).css({
            ...
            opacity: "1",
            transform: "translateX(0px)"
        }).css("z-index", "20"), e.parents(".testimonial_slider:not(.disable-height-animation)").find(".slides").stop(!0, !0).animate({height: n + 40 + "px"}, 450, "easeOutCubic")
    }, i.prototype.minimalNextPrevSelect = function (i) {
        var e, s = t(i.currentTarget), l = t("body.vc_editor").length > 0 ? "> div" : "blockquote",
            n = s.parents(".testimonial_slider").find(".slides " + l + ".active").index(), a = n;
        return s.parents(".testimonial_slider").find(".slides " + l).addClass("no-trans"), s.parents(".testimonial_slider").find(".slides " + l).css({
            ...
            opacity: "1",
            transform: "translateX(0px)"
        }).css("z-index", "20"), s.parents(".testimonial_slider").find(".control-wrap ul").css({transform: "translateX(-" + 20 * a + "px)"})) : (a = n - 1 == -1 ? s.parents(".testimonial_slider").find(".slides " + l).length - 1 : n - 1, e = s.parents(".testimonial_slider").find(".slides " + l).eq(n - 1).height(), s.parents(".testimonial_slider").find(".slides " + l).eq(n - 1).addClass("active").removeClass("no-trans").css({
            opacity: "1",
            transform: "translateX(0px)"
        }).css("z-index", "20"), s.parents(".testimonial_slider").find(".control-wrap ul").css({transform: "translateX(-" + 20 * a + "px)"})), s.parents(".testimonial_slider:not(.disable-height-animation)").find(".slides").stop(!0, !0).animate({height: e + 40 + "px"}, 450, "easeOutCubic"), !1
    }, i.prototype.testimonialRotate = function () {
        var t = this.el.find("li").length, i = this.el.find(".pagination-switch.active").parent().index();
        ...
        if (!this.el.is(".disable-height-animation") && !this.el.is('[data-style*="multiple_visible"]')) {
            ...
            this.el.find(".slides").stop(!0, !0).css({height: s + 40 + "px"})
        }
        ...
        if (this.el.is(".disable-height-animation") && !this.el.is('[data-style*="multiple_visible"]')) {
            ...
            }), 0 == i && (i = 100), this.el.find(".slides").css("height", i + 40 + "px"), this.el.animate({opacity: "1"}), this.fullWidthContentColumns()
        }
